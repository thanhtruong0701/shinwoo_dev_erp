<template>
    <v-dialog id="hr-user-dialog" max-width="1200" v-model="dialogIsShow">
...
export default {
    ...
    methods: {
        ...
        async orgchanged(org_pk, org){
            if( this.selectedCompany != org["TCO_COMPANY_PK"] ) {
                ...
                this.header1 = [
                    ...
                    { title: ("join_dt"        ) , field:"JOIN_DT"          , editable: false  , type: "date" , width: 100},
                    { title: ("left_dt"        ) , field:"LEFT_DT"          , editable: false  , type: "date" , width: 100},
                ];
        ...
        async onSearch(p_search) {
            ...
            let dso = {
                type: 'grid',
                selpro: 'tmc_sel_1071040_employee_user',
                para: [...pa],
            }
