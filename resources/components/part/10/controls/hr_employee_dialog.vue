<template>
    <v-dialog id="hr-employee-dialog" max-width="1200" v-model="dialogIsShow">
    ...
    export default {
        ...
        methods: {
            ...
            async onSearch(p_search) {
                let pa = p_search;
                let para_extra = [this.sex];
                
                let dso = {
                    type: 'grid',
                    selpro: this.foreigner ? "SYS_SEL_EMP_DIALOG_FOREIGNER" : 'SYS_SEL_EMPLOYEE_DIALOG_v2',
                    para: [...pa],
                    para_extra: [...para_extra]
                }
