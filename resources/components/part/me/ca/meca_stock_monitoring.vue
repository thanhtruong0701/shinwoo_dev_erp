...
<v-container fluid class="pa-2" v-resize="onResize">
  <v-row dense>
    <v-col md="1">
      <div class="d-flex justify-end pt-2">
        <b class="primary--text">Stock Status:&nbsp;</b>
      </div>
    </v-col>
    <v-col md="2">
  ...
  <v-row dense class="mb-3" v-if="totalQty != 0 && type01 != 1">
    <div class="div02">
      <div :class="boolActive01 ? 'div25' : 'div03'">
        <table class="table01">
          ...
          <tr>
            <td class="td01">
              <p class="p04">
                {{ arrTop5[0].QTY.toLocaleString("en", { minimumFractionDigits: 0, maximumFractionDigits: 0, }) }} </p>
              <p class="p05">&nbsp;{{ arrTop5[0].UOM }}</p>
            </td>
          </tr>
        </table>
      </div>
      <div :class="boolActive02 ? 'div25' : 'div03'">
        <table class="table01">
          ...
          <tr>
            <td class="td01">
              <p class="p04"> {{ arrTop5[1].QTY.toLocaleString("en", { minimumFractionDigits: 0, maximumFractionDigits: 0, }) }} </p>
              <p class="p05">&nbsp;{{ arrTop5[1].UOM }}</p>
            </td>
          </tr>
        </table>
      </div>
      <div :class="boolActive03 ? 'div25' : 'div03'">
        <table class="table01" >
          ...
          <tr>
            <td class="td01">
              <p class="p04"> {{ arrTop5[2].QTY.toLocaleString("en", { minimumFractionDigits: 0, maximumFractionDigits: 0, }) }} </p>
              <p class="p05">&nbsp;{{ arrTop5[2].UOM }}</p>
            </td>
          </tr>
        </table>
      </div>
      <div :class="boolActive04 ? 'div25' : 'div03'">
        <table class="table01" >
          ...
          <tr>
            <td class="td01">
              <p class="p04"> {{ arrTop5[3].QTY.toLocaleString("en", { minimumFractionDigits: 0, maximumFractionDigits: 0, }) }} </p>
              <p class="p05">&nbsp;{{ arrTop5[3].UOM }}</p>
            </td>
          </tr>
        </table>
      </div>
      <div :class="boolActive05 ? 'div25' : 'div03'">
        <table class="table01">
          ...
          <tr>
            <td class="td01">
              <p class="p04"> {{ arrTop5[4].QTY.toLocaleString("en", { minimumFractionDigits: 0, maximumFractionDigits: 0, }) }} </p>
              <p class="p05">&nbsp;{{ arrTop5[4].UOM }}</p>
            </td>
          </tr>
        </table>
      </div>
      <div :class="boolActive06 ? 'div25' : 'div03'">
        <table class="table01" >
          ...
          <tr>
            <td class="td01">
              <p class="p23"> {{ totalQty.toLocaleString("en", { minimumFractionDigits: 0, maximumFractionDigits: 0, }) }} </p>
              <!-- <p class="p05">&nbsp;</p> -->
            </td>
          </tr>
        </table>
