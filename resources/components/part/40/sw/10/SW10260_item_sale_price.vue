...
export default {
    ...
    async mounted() {
        //this.getCurrency();
        //this.txtyear = this.defaultParas.YEAR_CURRENT;
    ...
    computed: {
     ...
     return[
        ...
        {field: "CURRENT_PRICE_UOM", width: 115,title: ("CURRENT_PRICE_UOM"),alignment: "left",visible: true,},
        {field: "CURRENT_DELIVERY_TERM", width: 60,title: ("CURRENT_DELIVERY_TERM"),alignment: "left",visible: true,},
		...
		{field: "CURRENT_PRICE_SPSU23_VND", width: 65,title: ("CURRENT_PRICE_SPSU23_VND"),alignment: "right",type: "number",visible: false,format:"###,###,###.0",},
		{field: "NEW_PRICE_FAHO23_VND", width: 65,title: ("NEW_PRICE_FAHO23_VND"),alignment: "right",type: "number",visible: false,format:"###,###,###.0",},
    ...
    methods: {
		...
		const dso = {
          type: "process",
          updpro: "SW_SEL_SW10260_PRICE_NOCACHE",
          para: paramsData,
        };
