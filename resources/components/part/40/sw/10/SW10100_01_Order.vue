...
export default {
	...
	header1(){
       return[
        {field: "MATERIAL_CODE", width: 80,title: "material_code",alignment: "left",type: "text",visible: false},
        {field: "PO", width: 115,title: ("po_no"),alignment: "left",type: "text",visible: true},
        {field: "PRODUCT_CODE", width: 100,title: ("PRODUCT_CODE"),alignment: "left",type: "text",visible: true},
        {field: "OGAC_DATE", width: 115,title: ("OGAC_DATE"),alignment: "left",visible: true,allowEditing: true,},
        {field: "STICKER_NUM01", width: 60,title: ("STICKER_NUM01"),alignment: "left",visible: true,allowEditing: true,},
        {field: "GAC_DATE", width: 95,title: ("GAC_DATE"),alignment: "left",visible: true,allowEditing: true,},
        {field: "QTY", width: 375,title: ("QTY"),alignment: "right",type: "number",visible: true},
        {field: "COMPANY_CODE", width: 95,title: ("COMPANY_CODE"),alignment: "left",type: "text",visible: true,allowEditing: true,},
        {field: "FACTORY_CODE", width: 75,title: ("FACTORY_CODE"),alignment: "center",type: "text",visible: true},
        {field: "IMPORT_DATE", width: 65,title: ("IMPORT_DATE"),alignment: "center",type: "text",visible: true},
     ]
    },
    },
    methods: {
        ...
        async search(paramsData) {
            const dso = {
				  type: "process",
				  updpro: "SW_SEL_SW10100_01_ORDER",
				  para: paramsData,
				};
