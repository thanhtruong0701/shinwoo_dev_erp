...
export default {
    ...
    methods: {
        async getCurrency() {
            ...
            //this.lstCCY = commoncode[1];
			
			this.FactoryList = commoncode[0];
        },
	 ...
	 this.header1 =
		...
		{field: "FACTORY_CODE", width: 80,title: "FACTORY_CODE",type: "list",datasource: { KEY: 'CODE', VALUE:'NAME', data: this.FactoryList},editable: true},	
        ...
        {field: "SUPPLIER_LOCATION", width: 115,title: ("SUPPLIER_LOCATION"),alignment: "left",visible: true,allowEditing: true,},
        {field: "SUPPLIER_LOCATION_CODE", width: 60,title: ("SUPPLIER_LOCATION_CODE"),alignment: "left",visible: true,allowEditing: true,},
        {field: "SUPPLIER_LOCATION_COUNTRY", width: 95,title: ("SUPPLIER_LOCATION_COUNTRY"),alignment: "left",visible: true,allowEditing: true,},
        {field: "MATERIAL_NAME", width: 375,title: ("MATERIAL_NAME"),alignment: "left",type: "text",visible: true},
        {field: "MXS", width: 95,title: ("MXS"),alignment: "left",type: "text",visible: true,allowEditing: true,},
		...
		{field: "CURRENT_PRICE_SPSU23", width: 65,title: ("CURRENT_PRICE_SPSU")+this.txtyear.substring(2),alignment: "right",type: "float",visible: true,allowEditing: true,format:"###,###,###.#####",},
        {field: "CURRENT_PRICE_UOM", width: 115,title: ("CURRENT_PRICE_UOM"),alignment: "left",visible: true,allowEditing: true,},
        {field: "CURRENT_DELIVERY_TERM", width: 60,title: ("CURRENT_DELIVERY_TERM"),alignment: "left",visible: true,allowEditing: true,},
		{field: "NEW_PRICE_FAHO23", width: 65,title: ("NEW_PRICE_FAHO")+this.txtyear.substring(2),alignment: "right",type: "float",visible: true,allowEditing: true,format:"###,###,###.#####",},
		{field: "QTY", width: 65,title: ("QTY"),alignment: "right",type: "number",visible: true,format:"###,###,###.0",allowEditing: true,},
		{field: "CURRENT_PRICE_SPSU23_VND", width: 65,title: ("CURRENT_AMOUNT_SPSU23"),alignment: "right",type: "number",visible: true,format:"###,###,###.##",},
		{field: "NEW_PRICE_FAHO23_VND", width: 65,title: ("NEW_AMOUNT_FAHO23"),alignment: "right",type: "number",visible: true,format:"###,###,###.##",},
		{field: "EX_RATE", width: 65,title: ("EX_RATE"),alignment: "right",type: "number",visible: false},
        {field: "NEW_PRICE_UOM", width: 375,title: ("NEW_PRICE_UOM"),alignment: "left",type: "text",visible: true},
        {field: "NEW_DELIVERY_TERM", width: 95,title: ("NEW_DELIVERY_TERM"),alignment: "left",type: "text",visible: true,allowEditing: true,},
        ...
        {field: "LENGTH_UOM", width: 115,title: ("LENGTH_UOM"),alignment: "left",visible: true,allowEditing: true,},
        {field: "CUTBL_WIDTH_QTY", width: 60,title: ("CUTBL_WIDTH_QTY"),alignment: "left",visible: true,allowEditing: true,},
        {field: "CUTBL_WIDTH_UOM", width: 95,title: ("CUTBL_WIDTH_UOM"),alignment: "left",visible: true,allowEditing: true,},
        {field: "CUTBL_LENGTH_QTY", width: 375,title: ("CUTBL_LENGTH_QTY"),alignment: "left",type: "text",visible: true},
        {field: "CUTBL_LENGTH_UOM", width: 95,title: ("CUTBL_LENGTH_UOM"),alignment: "left",type: "text",visible: true,allowEditing: true,},
        ...
        {field: "MOQ_UOM", width: 115,title: ("MOQ_UOM"),alignment: "left",visible: true,allowEditing: true,},
        {field: "SAMPLE_LEAD_TIME", width: 60,title: ("SAMPLE_LEAD_TIME"),alignment: "left",visible: true,allowEditing: true,},
        {field: "PRODUCTION_LEAD_TIME", width: 95,title: ("PRODUCTION_LEAD_TIME"),alignment: "left",visible: true,allowEditing: true,},
        {field: "REMARKS", width: 375,title: ("REMARKS"),alignment: "left",type: "text",visible: true},
        {field: "DATE_YYYY", width: 95,title: ("DATE_YYYY"),alignment: "left",type: "text",visible: true,allowEditing: true,}
     ];
    },
        ...
        async search(paramsData) { 
			this.txtyear =paramsData[2];
		const dso = {
          type: "process",
          updpro: "SW_SEL_SW10260_FACTORY_NOCACHE",
          para: paramsData,
        };
        ...
        async save(searchParams) {
			let pa = searchParams;
        //pa.push(this.selectedPeriod);
       // pa.push(this.selectedMonth.replace(/[^0-9]/g,''));
        const dso = {
          type: 'grid',
          selpro: 'SW_SEL_SW10260_FACTORY_NOCACHE',
          updpro: 'SW_UPD_SW10260_FACTORY_NOCACHE',
          para: pa,
          elname:[
            "_rowstatus", 'PK', "FACTORY_CODE", "EVENT_TYPE", 'MATERIAL_TYPE', "MATERIAL_SUB_TYPE", "SUPPLIER_LOCATION",
             "SUPPLIER_LOCATION_CODE", "SUPPLIER_LOCATION_COUNTRY", "MATERIAL_NAME", "MXS", "PDM_MATERIAL_NUM", "PCX_SUPPLIER_MATERIAL_ID",
             "PCX_MATERIAL_ID", "CURRENT_PRICE_SPSU23", "CURRENT_PRICE_UOM", "CURRENT_DELIVERY_TERM", "NEW_PRICE_FAHO23","QTY", 
             "CURRENT_PRICE_SPSU23_vnd", "NEW_PRICE_FAHO23_vnd","EX_RATE", "NEW_PRICE_UOM", "NEW_DELIVERY_TERM", "PERCENT_CHG_IN_PRICE", "WIDTH_QTY",  "WIDTH_UOM", "LENGTH_QTY",
             "LENGTH_UOM", "CUTBL_WIDTH_QTY", "CUTBL_WIDTH_UOM", "CUTBL_LENGTH_QTY", "CUTBL_LENGTH_UOM", "WEIGHT_GRAMS_PER_UOM",
             "MOQ_QTY", "MOQ_UOM", "SAMPLE_LEAD_TIME", "PRODUCTION_LEAD_TIME", "REMARKS", "DATE_YYYY"
          ]
        }

        this.$refs.grdAccount.onSave(dso);
