...
export default {
    ...
    computed: {
		...
		header1() {
				return[
						...
						{field: "CP_DATE", width: 95,title: "factory",alignment: "left",type: "text",visible: true,allowEditing: true,},
						{field: "IMPORT_COUNTRY", width: 95,title: "country",alignment: "left",type: "text",visible: true,allowEditing: true,},
    ...
    methods: {
        ...
        async search(paramsData) {
            ...
            const dso = {
				  type: "process",
				  updpro: "SW_SEL_SW10110_01EX_V2_NOCACHE",//SW_SEL_SW10110_01_export_data
				  para: paramsData,
				};
