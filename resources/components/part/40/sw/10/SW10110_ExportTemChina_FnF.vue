...
export default {
    ...
    async mounted() {
        this.getCurrency();
        //this.txtlstFactory = this.defaultParas.FACTORY;
    ...
    computed: {
        ...
        header1() {
				if(this.txtlstFactory="VJ1")
				{
					return[
						{field: "GOODS", width: 150,title: "GOODS",alignment: "left",type: "text",visible: true},
						{field: "BARCODE", width: 115,title: "BARCODE",alignment: "left",type: "text",visible: true},
						{field: "QR_CODE", width: 115,title: "QR_CODE",alignment: "left",type: "text",visible: true},
						{field: "SIZES", width: 100,title: "SIZES",alignment: "left",type: "text",visible: true},
						{field: "COLOR", width: 115,title: "COLOR",alignment: "left",visible: true,allowEditing: true,},
						{field: "GUBUN", width: 60,title: "GUBUN",alignment: "left",visible: true,allowEditing: true,},
						{field: "MATERIAL", width: 95,title: "MATERIAL",alignment: "left",visible: true,allowEditing: true,},
						{field: "MIXRATE", width: 375,title: "MIXRATE",alignment: "left",type: "text",visible: true},
						{field: "COUNTRY", width: 95,title: "COUNTRY",alignment: "left",type: "text",visible: true,allowEditing: true,},
						{field: "VD_NM", width: 150,title: "VD_NM",alignment: "left",type: "text",visible: true},
						{field: "PRODUCT_YM", width: 115,title: "PRODUCT_YM",alignment: "left",type: "text",visible: true},
						{field: "DEGREE", width: 115,title: "DEGREE",alignment: "left",type: "text",visible: true},
						{field: "QTY", width: 115,title: "QTY",alignment: "right",type: "text",visible: true},
						{field: "STT1", width: 115,title: "STT",alignment: "left",type: "text",visible: true},
						{field: "LABEL_DESCRIPT", width: 115,title: "LABEL_DESCRIPT",alignment: "left",type: "text",visible: false},
					]
				}
				else
				{
    ...
    methods: {
        ...
        async search(paramsData) {
            ...
            const dso = {
				  type: "process",
				  updpro: "SW_SEL_SW10110_EXP_FNF_NOCACHE",
				  para: paramsData,
				};
