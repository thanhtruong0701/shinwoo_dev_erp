                    ...
                    <v-card outlined tile v-resize="onResize">
                        <v-col cols="12">
                           <BaseGridView :headertype="1" ref='grdAccount' 
								...
								:header="header1"
								@cellClickData="onCellClickDataGridExp"								
							  ></BaseGridView>
                        </v-col>
                        <!-- allow-save-custom -->
...
export default {
    ...
    computed: {
		...
		header1(){
       return[ 
		{field: "CNT", width: 80,title: "cnt",alignment: "left",type: "text",visible: true},
        {field: "MATERIAL_NO", width: 120,title: "material_no",alignment: "left",type: "text",visible: true},
        {field: "PRODUCT_NAME_EN", width: 150,title: ("product_name_en"),alignment: "left",type: "text",visible: true},
        {field: "PRODUCT_NAME_JP", width: 150,title: ("product_name_jp"),alignment: "left",type: "text",visible: true},
        {field: "FOOTWEAR_PURPOSE", width: 100,title: ("footwear_purpose"),alignment: "left",visible: true,allowEditing: true,},
        {field: "NO", width: 50,title: ("no_label"),alignment: "left",visible: true,allowEditing: true,},
        {field: "UPPER_JP", width: 150,title: ("upper_jp"),alignment: "left",visible: true,allowEditing: true,},
        {field: "OUTSOLE_JP", width: 150,title: ("outsole_jp"),alignment: "left",type: "text",visible: true},
		{field: "OTHER", width: 100,title: ("other"),alignment: "left",type: "text",visible: true},
        {field: "QTY", width: 95,title: ("qty"),alignment: "right",type: "number",visible: true,allowEditing: true,},
     ]
    },
    },
    methods: {
        ...
        async search(paramsData) {
			 const dso = {
				  type: "process",
				  updpro: "SW_SEL_SW10100_export_data",
				  para: paramsData,
				};
		...
		*/
		...
		onCellClickDataGridExp({PRODUCT_NAME_JP}) {
		let unorm = require('unorm');
		
		//console.log('æøåäüö'.normalize('NFKD'));
		  this.P_PRODUCT_NAME_JP = PRODUCT_NAME_JP;
		  this.P_PRODUCT_NAME_JP_2 = unorm.nfkc(this.P_PRODUCT_NAME_JP);//this.P_PRODUCT_NAME_JP.normalize("NFKD");
		  console.log(this.P_PRODUCT_NAME_JP_2);//console.log font japan is ok-->research to insert or show data for file is ok.
