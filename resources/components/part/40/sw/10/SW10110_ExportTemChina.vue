...
export default {
    ...
    computed: {
        ...
        header1() {
				return[
						...
						{field: "TOTAL_QTY", width: 275,title: "qty" ,alignment: "right",type: "number",visible: true},
						{field: "TOTAL_QTY2", width: 275,title: "total_qty" ,alignment: "right",type: "number",visible: true},
    ...
    methods: {
        ...
        async search(paramsData) {
            ...
            const dso = {
				  type: "process",
				  updpro: "SW_SEL_SW10110_EXPORT_NOCACHE",
				  para: paramsData,
				};
