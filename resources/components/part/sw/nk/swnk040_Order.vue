...
export default {
    ...
    computed: {
		...
		header1(){
     return[
        {field: "MATERIAL_CODE", width: 100,title: "material_code",alignment: "left",type: "text",visible: true},
        {field: "PO_NO", width: 115,title: ("po_no"),alignment: "left",type: "text",visible: true},
        {field: "VENDER_CODE", width: 120,title: ("vender_code"),alignment: "left",type: "text",visible: true},
        {field: "PLANNING_SEASON", width: 115,title: ("planning_season"),alignment: "left",visible: false,allowEditing: true,},
