    ...
    computed: {
        ...
        passwordConfirmationRule() {
			...
			return[
					...
					{field: "LOT_NO", width: 80,title: "LOT_NO",alignment: "left",type: "text",visible: true},
					{field: "PRODUCT_CODE", width: 115,title: ("PRODUCT_CODE"),alignment: "left",type: "text",visible: true},
					{field: "PO_NO", width: 100,title: ("PO_NO"),alignment: "left",type: "text",visible: true},
					{field: "CODE", width: 115,title: ("CODE"),alignment: "left",visible: true,allowEditing: true,},
					{field: "ITEM_DESCRIPTION", width: 60,title: ("ITEM_DESCRIPTION"),alignment: "left",visible: true,allowEditing: true,},
					{field: "QTY", width: 375,title: ("QTY"),alignment: "left",type: "number",visible: true},
					{field: "OGAC_DATE", width: 95,title: ("OGAC_DATE"),alignment: "left",type: "text",visible: true,allowEditing: true,},
					{field: "DEMANDS", width: 75,title: ("DEMANDS"),alignment: "center",type: "text",visible: true},
					{field: "SEASON", width: 65,title: ("SEASON"),alignment: "right",type: "number",visible: true},
				 ]
				},
    },
    methods: {
