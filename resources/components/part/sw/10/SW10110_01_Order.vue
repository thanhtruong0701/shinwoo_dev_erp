...
export default {
    ...
    computed: {
		...
		header1(){
     return[
        {field: "MATERIAL_CODE", width: 80,title: "material_code",alignment: "left",type: "text",visible: true},
        ...
        {field: "SIZE_NUM", width: 75,title: ("size_num"),alignment: "center",type: "text",visible: true},
    ...
    methods: {
        ...
        async search(paramsData) {
			const dso = {
				  type: "process",
				  updpro: "SW_SEL_SW10110_01_ORDER",
				  para: paramsData,
				};
