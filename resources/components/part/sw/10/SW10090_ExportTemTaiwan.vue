...
export default {
    ...
    computed: {
        ...
        passwordConfirmationRule() {
		 ...
		 header1() {
				return[
						{field: "STYLE_COLOR", width: 80,title: "STYLE_COLOR",alignment: "left",type: "text",visible: true},
						...
						{field: "OGAC", width: 115,title: ("OGAC"),alignment: "left",visible: true,allowEditing: true,},
						{field: "LABEL", width: 60,title: ("LABEL"),alignment: "left",visible: true,allowEditing: true,},
						{field: "CP_DATE", width: 95,title: ("CP_DATE"),alignment: "left",visible: true,allowEditing: true,},
						{field: "PO", width: 375,title: ("PO"),alignment: "left",type: "text",visible: true},
						{field: "QTY", width: 95,title: ("QTY"),alignment: "left",type: "number",visible: true,allowEditing: true,},
						{field: "FIX", width: 95,title: ("FIX"),alignment: "left",type: "text",visible: true,allowEditing: true,},
						{field: "THEM", width: 95,title: ("THEM"),alignment: "left",type: "text",visible: true,allowEditing: true,},
					]
        },
    ...
    methods: {
        ...
        async search(paramsData) {
			 const dso = {
				  type: "process",
				  updpro: "SW_SEL_SW10090_EXPORT_NOCACHE",
				  para: paramsData,
				};
