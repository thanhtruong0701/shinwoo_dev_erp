    ...
    computed: {
        ...
        header1() {
				return[
						...
						{field: "QTY", width: 95,title: ("QTY"),alignment: "left",type: "text",visible: true,allowEditing: true,},
						{field: "FIX", width: 95,title: ("FIX"),alignment: "left",type: "text",visible: false,allowEditing: true,},
						{field: "THEM", width: 95,title: ("THEM"),alignment: "left",type: "text",visible: false,allowEditing: true,},
					]
        },
    },
    methods: {
        ...
        async search(paramsData) {
			 const dso = {
				  type: "process",
				  updpro: "SW_SEL_SW10090_01_export_data",
				  para: paramsData,
				};
