...
export default {
    ...
    computed: {
       ...
       return[
        ...
        {field: "FIX", width: 75,title: ("FIX"),alignment: "center",type: "text",visible: false},
        {field: "THEM", width: 65,title: ("THEM"),alignment: "center",type: "text",visible: false},
     ]
    },
    },
    methods: {
        ...
        async search(paramsData) {
			 const dso = {
				  type: "process",
				  updpro: "SW_SEL_SW10100_01_EXPORT_DATA",
				  para: paramsData,
				};
