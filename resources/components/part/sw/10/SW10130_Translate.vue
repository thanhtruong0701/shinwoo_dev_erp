...
<v-container fluid class="pa-0">
    <v-row no-gutters>
        <v-col cols="12">
            <!-- Data Table SW_SEL_SW10130_TRANSLATE -->
...
export default {
    ...
    computed: {
		...
		header1() {
					return[
						{field: "ID", width: 80,title: "ID",alignment: "left",type: "text",visible: false},
						{field: "TYPE", width: 115,title: ("TYPE"),alignment: "left",type: "text",visible: true},
						{field: "CODE", width: 100,title: ("CODE"),alignment: "left",type: "text",visible: true},
						{field: "NAME", width: 115,title: ("NAME"),alignment: "left",visible: true,allowEditing: true,},
						{field: "NAME_EN", width: 60,title: ("NAME_EN"),alignment: "left",visible: true,allowEditing: true,},
						{field: "NAME_JP", width: 95,title: ("NAME_JP"),alignment: "left",visible: true,allowEditing: true,},
						{field: "IMP_CODE", width: 375,title: ("IMP_CODE"),alignment: "left",type: "text",visible: true},
						{field: "LANG", width: 95,title: ("LANG"),alignment: "left",type: "text",visible: true,allowEditing: true,},
					]
				},
    },
    methods: {
        ...
        async search(paramsData) {
            const dso = {
				  type: "process",
				  updpro: "SW_SEL_SW10130_TRANSLATE",
				  para: paramsData,
				};
