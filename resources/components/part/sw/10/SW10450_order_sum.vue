...
export default {
    ...
    computed: {
     ...
     return[
        ...
        {field: "STT", width: 50,title: "STT",alignment: "left",type: "text",visible: true},
        {field: "ORDERNO", width: 70,title: ("ORDER_NO"),alignment: "left",type: "text",visible: true},
        {field: "STYLE_NO", width: 100,title: ("STYLE_NO"),alignment: "left",type: "text",visible: true},
        {field: "COLOR", width: 95,title: ("COLOR"),alignment: "left",visible: true,allowEditing: true,},
        {field: "SIZES", width: 50,title: ("SIZE"),alignment: "left",visible: true,allowEditing: true,},
		{field: "SERIAL_NO", width: 80,title: ("SERIAL_NO"),alignment: "left",visible: true,allowEditing: true,},
        {field: "EPC", width: 275,title: ("EPC"),alignment: "left",visible: true,allowEditing: true,},
        {field: "TID", width: 255,title: ("TID"),alignment: "left",type: "text",visible: true},
        {field: "REMARKS", width: 165,title: ("DESCRIPTION"),alignment: "left",type: "text",visible: true,allowEditing: true,}, 
     ]
    },
