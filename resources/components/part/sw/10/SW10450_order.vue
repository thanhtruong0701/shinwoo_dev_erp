...
export default {
    ...
    computed: {
        ...
        limitHeight() { return 570 },
		
		header1(){
     return[
        {field: "CUST_NAME_ENG", width: 100,title: "Customer",alignment: "left",type: "text",visible: true},
        {field: "KIND_NAME", width: 300,title: ("KIND_NAME"),alignment: "left",type: "text",visible: true},
        {field: "TYPE_WEAR", width: 100,title: ("TYPE_WEAR"),alignment: "left",type: "text",visible: false},
        {field: "TYPE_ACC", width: 95,title: ("TYPE_ACC"),alignment: "left",visible: false,allowEditing: true,},
        {field: "QTY_RFID_Y", width: 120,title: ("QTY(RFID)"),alignment: "right",visible: true,allowEditing: true,formatFloat: 0,},
		{field: "QTY_RFID_N", width: 120,title: ("QTY(NORMAL)"),alignment: "right",visible: true,allowEditing: true,formatFloat: 0,},
        {field: "KIND_PR_MODE", width: 125,title: ("KIND_PR_MODE"),alignment: "left",visible: true,allowEditing: true,},
        {field: "TOTAL_QTY", width: 125,title: ("TOTAL_QTY"),alignment: "right",visible: true,formatFloat: 0},
     ]
    },
