...
export default {
    ...
    computed: {
        ...
        header1() {
				return[
						...
						{field: "FACTORY", width: 100,title: ("FACTORY"),alignment: "left",type: "text",visible: false},
						{field: "PRODUCT_CODE", width: 115,title: ("PRODUCT_CODE"),alignment: "left",visible: true,allowEditing: true,},
						{field: "STYLE_NAME", width: 60,title: ("STYLE_NAME"),alignment: "left",visible: true,allowEditing: true,},
						{field: "COLOR_DESCRIPTION", width: 95,title: ("COLOR_DESCRIPTION"),alignment: "left",visible: true,allowEditing: true,},
						{field: "COLOR_LOCAL_LANGUAGE_NAME", width: 375,title: ("COLOR_LOCAL_LANGUAGE_NAME"),alignment: "left",type: "text",visible: true},
						{field: "AGE ", width: 95,title: ("AGE"),alignment: "left",type: "text",visible: true,allowEditing: true,},
						{field: "GENDER", width: 75,title: ("GENDER"),alignment: "left",type: "text",visible: true},
						
						{field: "BUSINESS_ORGANIZATION", width: 75,title: ("BUSINESS_ORGANIZATION"),alignment: "left",type: "text",visible: true},
						{field: "CONSUMER_PURPOSE", width: 75,title: ("CONSUMER_PURPOSE"),alignment: "left",type: "text",visible: true},
						{field: "CONSUMER_FOCUS", width: 75,title: ("CONSUMER_FOCUS"),alignment: "left",type: "text",visible: true},
						{field: "PRIMARY_PLATFORM", width: 75,title: ("PRIMARY_PLATFORM"),alignment: "left",type: "text",visible: true},
						{field: "CHN_NAME", width: 75,title: ("CHN_NAME"),alignment: "left",type: "text",visible: true},
						{field: "GB_CODE", width: 75,title: ("GB_CODE"),alignment: "left",type: "text",visible: true},
						{field: "COMMENTS", width: 75,title: ("COMMENTS"),alignment: "left",type: "text",visible: true},
						{field: "MODEL_ID", width: 75,title: ("MODEL_ID"),alignment: "left",type: "text",visible: true},
						{field: "SUBCATEGORY", width: 75,title: ("SUBCATEGORY"),alignment: "left",type: "text",visible: true},
    ...
    methods: {
        ...
        async search(paramsData) {
			const dso = {
				  type: "process",
				  updpro: "SW_SEL_SW10110_SEASON_NOCACHE",
				  para: paramsData,
				};
