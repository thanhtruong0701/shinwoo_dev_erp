...
export default {
    ...
    data: () => ({
        ...
        columnHeaders: [],
        txtBookCcy: "VND",
		//lstCompany_code: null,
        multiSelectMode: false,
    }),
    async mounted() {
        this.getCurrency();
        //this.txtBookCcy = this.defaultParas.BOOK_CCY;
        console.log("aaa :",this.defaultParas);
		//this.lstCompany_code=this.defaultParas.TCO_COMPANY_PK;
		//console.log(this.lstCompany_code);
    },
    computed: {
        user() {
		...
		header1(){
     return[
        {field: "MATERIAL_CODE", width: 80,title: "No",alignment: "center",type: "text",visible: true},
        {field: "PO_NO", width: 115,title: ("po_no"),alignment: "left",type: "text",visible: true},
        {field: "VENDER_CODE", width: 100,title: ("vender_code"),alignment: "left",type: "text",visible: true},
        {field: "PLANNING_SEASON", width: 115,title: ("planning_season"),alignment: "left",visible: true,allowEditing: true,},
        {field: "GENDER", width: 60,title: ("gender"),alignment: "left",visible: true,allowEditing: true,},
        ...
        {field: "ORDER_DATE", width: 95,title: ("order_date"),alignment: "left",type: "text",visible: true,allowEditing: true,},
        {field: "SIZE_NUM", width: 75,title: ("size_num"),alignment: "center",type: "text",visible: false},
    ...
    methods: {
		...
		const dso = {
          type: "process",
          updpro: "SW_SEL_SW10110_ORDER_M_NOCACHE",
          para: paramsData,
        };
