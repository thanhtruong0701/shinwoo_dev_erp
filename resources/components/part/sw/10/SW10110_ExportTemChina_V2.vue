...
export default {
    ...
    computed: {
        ...
        header1() {
				return[
						...
						{field: "QTY", width: 115,title: "qty",alignment: "right",type: "number",visible: false,allowEditing: true,},
						{field: "LOSS_QTY", width: 60,title: "loss_qty" ,alignment: "right",type: "number",visible: false,allowEditing: true,},
						{field: "PRINTED_QTY", width: 95,title: "printed_qty",alignment: "right",type: "number",visible: false,allowEditing: true,},
    ...
    methods: {
        ...
        async search(paramsData) {
            ...
            const dso = {
				  type: "process",
				  updpro: "SW_SEL_SW10110_EXP_V2_NOCACHE",
				  para: paramsData,
				};
