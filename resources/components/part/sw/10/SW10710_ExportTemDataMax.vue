...
export default {
    ...
    computed: {
        ...
        header1() {
				return[
						{field: "COMPANY", width: 150,title: "company",alignment: "left",type: "text",visible: true},
						{field: "PO_NO", width: 115,title: "po_no",alignment: "left",type: "text",visible: true},
						{field: "STYLE_NO", width: 100,title: "style_no",alignment: "left",type: "text",visible: true},
						{field: "TYPE_SHOES", width: 115,title: "type_shoeS",alignment: "left",visible: true,allowEditing: true,},
						{field: "OGAC", width: 60,title: "ogac",alignment: "left",visible: true,allowEditing: true,},
						{field: "ZIP_CODE", width: 95,title: "zip_code",alignment: "left",visible: true,allowEditing: true,},
						{field: "SIZES", width: 375,title: "sizes",alignment: "left",type: "text",visible: true},
						{field: "SIZE_CM", width: 95,title: "size_cm",alignment: "left",type: "text",visible: true,allowEditing: true,},
						{field: "GENDER", width: 150,title: "gender",alignment: "left",type: "text",visible: true},
						{field: "PRICE_01", width: 115,title: "price_01",alignment: "right",type: "number",visible: true},
						{field: "PRICE_02", width: 100,title: "price_02",formatFloat: '0',visible: true},
						{field: "QTY", width: 115,title: "qty",alignment: "right",type: "number",visible: true,allowEditing: true,},
						{field: "BIS_LICENSE", width: 100,title: "bis_license",alignment: "left",type: "text",visible: true},
						{field: "IS_NO", width: 80,title: "is_no",alignment: "left",type: "text",visible: true},
						{field: "PART_NO", width: 70,title: "part_no",alignment: "left",type: "text",visible: true},
						{field: "TYPE_NO", width: 70,title: "type_no",alignment: "left",type: "text",visible: true},
						{field: "HEEL_DROP", width: 90,title: "heel_drop",alignment: "left",type: "text",visible: true},
					]
        },
    },
    methods: {
        ...
        async search(paramsData) {
            ...
            const dso = {
				  type: "process",
				  updpro: "SW_SEL_SWSO710_EXPORT_NOCACHE",
				  para: paramsData,
				};
