        ...
        <v-card-text class="pa-0">
          <v-container>
            <v-row dense align="start" justify="center">
              ...
              <v-col offset-md="2" md="2" class="pt-0" align="right">
            ...
            <v-row dense align="start" justify="center">
              <v-col offset-md="8" md="4" class="pt-0" align="right">
								<div class="d-flex justify-end">
									<BaseButton icon_type="add" :btn_text="$t('add')" :disabled="isProcessing" @onclick="onClickButton('btnSelectItemStock')"/>
									<BaseButton icon_type="delete" :btn_text="$t('delete')" :disabled="isProcessing" @onclick="onClickButton('btnRemoveItemStock')"/>
