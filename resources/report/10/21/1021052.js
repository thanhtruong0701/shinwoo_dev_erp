...
let reportList = [];
let reportDefault = [
    { CODE: '01', NAME: '01 - WORKING SUMMARY', REPORT_PATH: 'report/10/21/1021052_working_summary.xlsx'}, 
    { CODE: '02', NAME: '02 - WORKING DETAIL', REPORT_PATH: 'report/10/21/1021052_working_detail.xlsx'}, 
    { CODE: '03', NAME: '03 - ABSENCE SUMMARY', REPORT_PATH: 'report/10/21/1021052_absence_summary.xlsx'}, 
...
let printWorkingSummary = async ( that, reportInfo) => {
    ...
    const dsoData = {  type: 'grid',  selpro: 'HR_RPT_1021052_WORKING_SUMMARY', para: p_param };
...
let printWorkingDetail = async( that, reportInfo) => {
    ...
    const dsoComp = {  type: 'grid',  selpro: 'HR_RPT_1020050_COMPANY_INFO', para: [that.selectedOrg, that.selectedMonth]  };
    const dsoData = {  type: 'grid',  selpro: 'HR_RPT_1021052_WORKING_DETAIL', para: p_param };
...
let printAbsenceSummary = async( that, reportInfo) => {
    ...
    const dsoComp = {  type: 'grid',  selpro: 'HR_RPT_1020050_COMPANY_INFO', para: [that.selectedOrg, that.selectedMonth]  };
    const dsoData = {  type: 'grid',  selpro: 'HR_RPT_1021052_ABSENCE_SUMMARY', para: p_param };
