let reportList= [   
    ...
    // { CODE: '20', NAME: '20 - Payroll Total', REPORT_PATH: 'report/10/31/dy/1030050_PAYROLL_TOTAL_DY.xlsx'}, 
    // { CODE: '21', NAME: '21 - Payroll 1', REPORT_PATH: 'report/10/31/dy/1030050_PAYROLL_1_DY.xlsx'}, 
    // { CODE: '22', NAME: '22 - Payroll 2', REPORT_PATH: 'report/10/31/dy/1030050_PAYROLL_2_DY.xlsx'}, 
    // { CODE: '23', NAME: '23 - Payslip', REPORT_PATH: 'report/10/31/dy/1030050_PAYSLIP_DY1.xlsx'}, 
    // { CODE: '24', NAME: '24 - Payment By Bank', REPORT_PATH: 'report/10/31/dy/1030050_payment_bank_dy.xlsx'}, 
    // { CODE: '25', NAME: '25 - Payslip OT', REPORT_PATH: 'report/10/31/dy/1030050_OT_PAYSLIP_DY.xlsx'}, 
    // { CODE: '26', NAME: '26 - Payroll Summary', REPORT_PATH: 'report/10/31/dy/1030050_payroll_summary_report.xlsx'}, 
    // { CODE: '27', NAME: '27 - Payroll Summary By SEQ', REPORT_PATH: 'report/10/31/dy/1030050_payroll_summary_report_seq.xlsx'}, 
    // { CODE: '28', NAME: '28 - Payroll Total By SEQ', REPORT_PATH: 'report/10/31/dy/1030050_PAYROLL_TOTAL_DY.xlsx'}, 
    // { CODE: '29', NAME: '29 - Payroll 1 By SEQ', REPORT_PATH: 'report/10/31/dy/1030050_PAYROLL_1_DY.xlsx'}, 
    // { CODE: '30', NAME: '30 - Payroll 2 By SEQ', REPORT_PATH: 'report/10/31/dy/1030050_PAYROLL_2_DY.xlsx'}, 
];
                ...
                excel = [
                  //sheet1
                    ...
                    //sheet2
                    {
                        ...
                        {   
                            sequence: "break",
                            startRow: 11, proc: "hr_rpt_1030050_payment_cash_dy", params: [...p_param] ,
                            param_extra: [...p_param_extra],
                            total: [
                                {   column: null, isDisplay: true, type: "SUM", text: that.$t("TOTAL"), isMerge: true, isGrandTotal: true , font: {  size: 15, bold: true } , merge: { from: 1, to: 4 }  }, //"Grand total: $[1] record(s) "
                            ]
                    ...
                    //sheet3
                    {
                        ...
                        {   
                            sequence: "break",
                            startRow: 11, proc: "hr_rpt_1030050_payment_cash_dy_2", params: [...p_param] ,
                            param_extra: [...p_param_extra],
                            total: [
                                {   column: null, isDisplay: true, type: "SUM", text: that.$t("TOTAL"), isMerge: true, isGrandTotal: true , font: {  size: 15, bold: true } , merge: { from: 1, to: 4 }  }, //"Grand total: $[1] record(s) "
                            ]
                    ...
                    //sheet4
                    {
                        ...
                        {   
                            sequence: "break",
                            startRow: 11, proc: "hr_rpt_1030050_payment_cash_r_dy", params: [...p_param] ,
                            param_extra: [...p_param_extra],
                            total: [
                                {   column: null, isDisplay: true, type: "SUM", text: that.$t("TOTAL"), isMerge: true, isGrandTotal: true , font: {  size: 15, bold: true } , merge: { from: 1, to: 4 }  }, //"Grand total: $[1] record(s) "
                            ]
                    ...
                    //sheet5
                    {
                        ...
                        {   
                            sequence: "break",
                            startRow: 11, proc: "hr_rpt_1030050_payment_cash_1_r_dy", params: [...p_param] ,
                            param_extra: [...p_param_extra],
                            total: [
                                {   column: null, isDisplay: true, type: "SUM", text: that.$t("TOTAL"), isMerge: true, isGrandTotal: true , font: {  size: 15, bold: true } , merge: { from: 1, to: 4 }  }, //"Grand total: $[1] record(s) "
                            ]
                    ...
                    //sheet6
                    {
                        ...
                        {   
                            sequence: "break",
                            startRow: 11, proc: "hr_rpt_1030050_payment_cash_2_r_dy", params: [...p_param] ,
                            param_extra: [...p_param_extra],
                            total: [
                                {   column: null, isDisplay: true, type: "SUM", text: that.$t("TOTAL"), isMerge: true, isGrandTotal: true , font: {  size: 15, bold: true } , merge: { from: 1, to: 4 }  }, //"Grand total: $[1] record(s) "
                            ]
