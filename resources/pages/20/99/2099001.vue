<template>
  <GwGridLayout dense align="start" colsPerRow="1" containerHeight="auto" @callBackHeight="parentHeight = $event">
    ...
    <DataGridView colspan="12" column-resizing-mode="widget" 
      ref="dataGrid" 
      :header="headers" 
      sel_procedure="LG_SEL_2099001_1_NOCACHE"
  ...
  computed: {
    ...
    headers() {
      return [
        ...
        { dataField: "PO_MASTER", caption: this.$t("po_master"), allowEditing: false },
        ...
        { dataField: "COLOR_CODE", caption: this.$t("color_code"), allowEditing: false },
        ...
        { dataField: "SEX", caption: this.$t("gender"), allowEditing: false }, 
