<template>
  ...
  <GwGridLayout dense align="start" colsPerRow="1" containerHeight="auto" @callBackHeight="parentHeight = $event">
    ...
    <DataGridView colspan="12" column-resizing-mode="widget" 
      ref="dataGrid" 
      :header="headers" 
      sel_procedure="SW_LG_SEL_2099011_1_NOCACHE"
    ...
    <DataGridView colspan="12" column-resizing-mode="widget" 
      ref="dataGrid_d" 
      :header="[  
        { dataField: 'ITEM', caption: this.$t('ITEM'), allowEditing: false },
        ...
        { dataField: 'UNIT_PRICE', caption: this.$t('UNIT_PRICE'), allowEditing: false, summaryType: 'sum', formatFloat: '6' },
      ...
      sel_procedure="SW_LG_SEL_2099011_2_NOCACHE"
  ...
  computed: {
    ...
    headers() {
      return [ 
        ...
        { dataField: "DESCRIPTION", caption: "ORDER_NM", allowEditing: false },     
        { dataField: "ATT01", caption: "STYLE", allowEditing: false },
  ...
  methods: {
    ...
    async confirm() {
      try {
        ...
        const dso = {
          type: "process",
          updpro: "SW_LG_PRO_2099011_CONFIRM",
          para: [ifNoPKArrayStr, ]
        };
    ...
    async cancel() {
     ...
     async onSync() {
      try {
        const dso = {
          type: "process",
          updpro: "SW_LG_INF_2099011_HAEIN",
