<template>
  <GwGridLayout dense align="start" colsPerRow="1" containerHeight="auto" @callBackHeight="parentHeight = $event">
    ...
    <DataGridView colspan="6" column-resizing-mode="widget" 
      ref="dataGrid" 
      :header="headers" 
      sel_procedure="LG_SEL_2099005_1_NOCACHE"
    ...
    <DataGridView colspan="6" column-resizing-mode="widget" 
      ref="dataGrid_d" 
      :header="[  
                    { dataField: 'ITEM_LNAME', caption: this.$t('style'), allowEditing: false },
                    { dataField: 'ORD_QTY', caption: this.$t('order_qty'), allowEditing: false , allowEditing: false, summaryType: 'sum', formatFloat: '0' },
      ...
      sel_procedure="LG_SEL_2099005_2_NOCACHE"
      :filter_paras="[this.order_pk]" 
      :filterRow="true" 
      :auto_load="false" :max_height="gridHeight" 
      @onRowPrepared="onRowPrepared_0" 
      @cellClickData="" 
