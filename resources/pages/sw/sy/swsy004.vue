      ...
      <v-col md="12">
        ...
        <v-row dense>
          <BaseGridView column-resizing-mode="widget" ref="grdViewTab3" :max_height="limitHeight"
            ...
            sel_procedure="SW_SEL_SWSY004_NOCACHE" upd_procedure="SW_UPD_SWSY004" :filter_paras="[
              this.itemovertime,
              this.date_from,
              this.base_date,
  ...
  methods: {
    ...
    async onReport2() {
      ...
      if (this.itemreporttype == "02") {
        ...
        report = "rpt_swsy004_rigister_overtime_entry_02";
