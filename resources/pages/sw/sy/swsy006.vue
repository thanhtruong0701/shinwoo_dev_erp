      ...
      <v-col md="12">
          ...
          <v-col cols="5">
            <v-row align="center" justify="space-between" no-gutters>
              <v-col md="4" class="pl-1">
                <BaseSelect :label="$t('Day_Type')" v-model="itempayment" :lstData="lstdatetype" item-text="NAME"
        ...
        <v-row dense>
          <BaseGridView column-resizing-mode="widget" ref="grdViewTab3" :max_height="limitHeight"
            ...
            sel_procedure="SW_SEL_SWSY006_NOCACHE" upd_procedure="SW_UPD_SWSY001" :filter_paras="[
              this.itempayment,
              this.date_from,
              this.base_date,
      ...
      for (let i = 0; i < arrDataSource.length; i++) {
        ...
        if (!this._hasValue(arrDataSource[i].REQUEST_DATE_OFF)) {
          this.$refs.alertDialog.showAlert(
            "warning",
            "warning",
            this.$t("pls_input_line_FROM_DATE_OFF_for_all_detail")
          );
          return false;
        }
        if (!this._hasValue(arrDataSource[i].REQUEST_DATE_OFF_TO)) {
          this.$refs.alertDialog.showAlert(
            "warning",
            "warning",
            this.$t("pls_input_line_TO_DATE_OFF_for_all_detail")
          );
          return false;
        }
        ...
        //   this.$refs.alertDialog.showAlert(
        //     "warning", "wraning", this.$t("pls_double_click_to_Confirm_Name")
        //   );
        //   return false;
        // }
      }
