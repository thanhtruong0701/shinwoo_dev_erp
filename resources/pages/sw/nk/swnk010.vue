                    ...
                    <v-row   no-gutters> 
                        ...
                        <v-col cols="3" class="pl-5 pt-3 pb-3">
                            <GwImportExcelFile 
								...
								:impEndCol="impEndCol" 
                                :impAddParam="[this.user.TCO_COMPANY_PK]"
        ...
        <v-row  no-gutters >
            <v-col cols="4" class="pt-2">
                <DataGridView
                    ...
                    sel_procedure="SZ_SEL_SWNK010_2"
                    upd_procedure="SZ_UPD_SWNK010_M"
                    :filter_paras="[
                       this.sel_Company, 
                       this.txt_PO_NO,
                       this.txtFrm_dt,
             ...
             <v-col cols="8" class="pt-2">
                <DataGridView
                    ...
                    :auto_load="true"
                    :max_height="this.windowHeight - 250"
                    sel_procedure="SZ_SEL_SWNK010_1"
                    upd_procedure="SZ_UPD_SWNK010_D"
    ...
    export default 
    {
        ...
        /*############### methods #######################*/
            ...
            {   
					...
					changeCustomer(idx)  
					{
						if(this.sel_Company=='VE-ANTA')
						{
							//alert(this.lstFactory);
							this.impEndCol = 25;
							this.imp_start_row=2;
							this.imp_template_file = 'report/sw/nk/swnk010_import_order.xlsx';  
							this.imp_store_prod = 'SZ_IMP_SWNK010_ORDER';
						} 
