                    ...
                    <v-tabs-items v-model="tab_control" v-resize="onResize">
                            ...
                            <v-row align="center" justify="center">
                                <v-col cols="12" class="py-0">
                                    <v-card outlined tile v-resize="onResize">
                                        <DataGridView ref="dataGridIOB" :header="headersIOB" sel_procedure="SW_SEL_SW10450_ORDER" select_mode="Single" :filter_paras="this._formatNullValuesToEmpty
										  ([this.dtFrom,
											this.dtTo,
                        ...
                        <v-tab-item>
                            <v-row align="center" justify="center">
                                <v-col cols="12" class="py-0">
                                    <v-card outlined tile v-resize="onResize">
                                        <DataGridView ref="dataGridOUT" :header="headersOUT" sel_procedure="SW_SEL_SW10450_SUM_TYPE" select_mode="Single" :filter_paras="this._formatNullValuesToEmpty
										([this.dtFrom,
											this.dtTo,
											this.selectedCompany,
											this.selectedOrderType		
                        ...
                        <v-tab-item>
                            <v-row align="center" justify="center">
                                <v-col cols="12" class="py-0">
                                    <v-card outlined tile v-resize="onResize">
                                        <DataGridView ref="dataGridIN" :header="headersIN" sel_procedure="SW_SEL_SW10450_ORDER_TYPE" select_mode="Single" :filter_paras="this._formatNullValuesToEmpty([
											this.dtFrom,
											this.dtTo,
											this.selectedCompany,
											this.selectedOrderType											
