    ...
    methods: {
        ...
        async createHeader(){
            ...
            this.header1 = [
                ...
                { title: ("ITEM_NAME"), field: "PRODUCT_NAME", editable: true, type: "", width: 270, fixed:true },
				...
				{ title: ("DELIVERY_DATE"), field: "GAC_DATE", editable: true, type: "", width: 100, cellclassname: this.changeBackground },
