...
export default {
    ...
    components: {
        ...
        tabOrder: () => import("@/components/part/sw/10/SW10110_Order_Mapping"),
        tabMCL: () => import("@/components/part/sw/10/SW10110_MCL_Mapping"),
        tabSeason: () => import("@/components/part/sw/10/SW10110_Season_Mapping"),
        tabTranslate: () => import("@/components/part/sw/10/SW10110_Translate"),
        tabExport: () => import("@/components/part/sw/10/SW10110_ExportTemChina_Mapping"),
    ...
    watch: {
        selectedTab(val) {
            ...
            if (val == "tabOrder") {//ORDER
					...
					this.imp_store_prod = 'SW_IMP_SW10110_ORDER_MAPPING';
            ...
            if (val == "tabMCL") {//MCL
                ...
                this.imp_store_prod = 'SW_IMP_SW10110_MCL_MAPPING';
            }
			if (val == "tabSeason") {//SEASON
                ...
                this.imp_store_prod = 'SW_IMP_SW10110_SEASON_MAPPING';
            }
    ...
    methods: {
      ...
      this.LengthUpper = lstCommoncode[0];
		...
		async OnDeleteMaster() {
			  let tab = 4;
				   alert("Delete Data Order And Season?");
				   const dso = {
					type: "process",
					updpro: "SW_PRO_SW10110_DELETE_MAPP_ORD",
					para: [this.selectedCompany, this.month.replace("-", ""), tab, this.lstFactory]
					};
					const result = await this._dsoCall(dso, "process", false);
					 setTimeout(() => { 
