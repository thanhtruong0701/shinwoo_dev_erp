            ...
            <v-row align="center" justify="center">
                <v-col cols="12" class="py-0">
                    <v-tabs dark background-color="#4DB6AC" class="mb-2" height="35" show-arrows next-icon="mdi-arrow-right-bold-box-outline" prev-icon="mdi-arrow-left-bold-box-outline" color="deep-orange darken-4" v-model="tab_control">
                        <v-tab>{{ $t('Sale Summary(Amount)') }}</v-tab>
                    ...
                    <v-tabs-items v-model="tab_control" v-resize="onResize">
                            ...
                            <v-row align="center" justify="center">
                                <v-col cols="12" class="py-0">
                                    <v-card outlined tile v-resize="onResize">
                                        <DataGridView ref="dataGridIOB" :header="headersIOB" sel_procedure="SW_SEL_SW10460_AMT_ORDER" select_mode="Single" :filter_paras="this._formatNullValuesToEmpty
										  ([this.dtFrom,
											this.dtTo,
                        ...
                        <v-tab-item>
                            <v-row align="center" justify="center">
                                <v-col cols="12" class="py-0">
                                    <v-card outlined tile v-resize="onResize">
                                        <DataGridView ref="dataGridBAL" :header="headersBAL" sel_procedure="SW_SEL_SW10450_LOCATION" select_mode="Single" :filter_paras="this._formatNullValuesToEmpty
										  ([this.dtFrom,
											this.dtTo,
											this.selectedCompany ,
                        ...
                        <v-tab-item>
                            <v-row align="center" justify="center">
                                <v-col cols="12" class="py-0">
                                    <v-card outlined tile v-resize="onResize">
                                        <DataGridView ref="dataGridOUT" :header="headersOUT" sel_procedure="SW_SEL_SW10450_SUM_TYPE" select_mode="Multiple" :filter_paras="this._formatNullValuesToEmpty
										([this.dtFrom,
											this.dtTo,
											this.selectedCompany,
											this.selectedOrderType		
                        ...
                        <v-tab-item>
                            <v-row align="center" justify="center">
                                <v-col cols="12" class="py-0">
                                    <v-card outlined tile v-resize="onResize">
                                        <DataGridView ref="dataGridIN" :header="headersIN" sel_procedure="SW_SEL_SW10450_ORDER_TYPE" select_mode="Multiple" :filter_paras="this._formatNullValuesToEmpty([
											this.dtFrom,
											this.dtTo,
											this.selectedCompany,
											this.selectedOrderType											
    ...
    computed: {
        ...
        headersIOB() {
            ...
            return [{
				...
				{
                    dataField: "AMOUNT_RFID",
                    caption: this.$t("AMOUNT(RFID)"),
					//dataType: 'number',
                    //formatFloat: 2,
					alignment: "right",
                    width: "100"
                ...
                {
                    dataField: "AMOUNT_NORMAL",
                    caption: this.$t("AMOUNT(NORMAL)"),
					//dataType: 'number',
                    //formatFloat: 2,
					alignment: "right",
                    width: "120"
						...
						switch (code) {
							case 0://reprt case summary customer
									...
									let report = "rpt_swso450_sumary_report";
										report_name = "rpt_swso450_sumary_report";
									  ...
									  //alert(p_param);
										this._ExcelSaveAs(await this.$axios.$get('/dso/makereport', {responseType: "blob", params: {
										  ...
										  excel: JSON.stringify([{
											insertRange: [{
											  range: "A2:F2", proc: "SW_SEL_SW10450_ORDER", params: [...p_param]//SW_SEL_SW10110_export_custom
											}],
											insertRows: [{
												startRow: 4, proc: "SW_SEL_SW10450_ORDER", params: [...p_param], stringColumns: [ "CUSTOMER_NAME","KIND_NAME"], subStyle: { font : {   bold: true   } , fill: {
																		type: 'pattern',
																		pattern:'solid',
																		fgColor : { argb: 'FFE599'},
																		bgColor : { argb: 'FFE599'}
							...
							case 1://case report location
								 p_param = [
									 ...
									 report = "rpt_swso450_sumary_location_report";
										report_name = "rpt_swso450_sumary_location_report";
									  ...
									  //alert(p_param);
										this._ExcelSaveAs(await this.$axios.$get('/dso/makereport', {responseType: "blob", params: {
										  ...
										  excel: JSON.stringify([{
											insertRange: [{
											  range: "A2:F2", proc: "SW_SEL_SW10450_LOCATION", params: [...p_param]//SW_SEL_SW10110_export_custom
											}],
											insertRows: [{
												startRow: 4, proc: "SW_SEL_SW10450_LOCATION", params: [...p_param], stringColumns: [ "CUSTOMER_NAME","KIND_NAME"], subStyle: { font : {   bold: true   } , fill: {
																		type: 'pattern',
																		pattern:'solid',
																		fgColor : { argb: 'FFE599'},
																		bgColor : { argb: 'FFE599'}
							...
							case 2://case report location
								 p_param = [
									 ...
									 report = "rpt_swso450_sumary_report_all";
										report_name = "rpt_swso450_sumary_report_all";
									  ...
									  //alert(p_param);
										this._ExcelSaveAs(await this.$axios.$get('/dso/makereport', {responseType: "blob", params: {
										  ...
										  excel: JSON.stringify([{
											insertRange: [{
											  range: "A2:F2", proc: "SW_SEL_SW10450_SUM_TYPE", params: [...p_param]//SW_SEL_SW10110_export_custom
											}],
											insertRows: [{
												startRow: 4, proc: "SW_SEL_SW10450_SUM_TYPE", params: [...p_param], stringColumns: [ "KIND_NAME","KIND_NAME"], subStyle: { font : {   bold: true   } , fill: {
																		type: 'pattern',
																		pattern:'solid',
																		fgColor : { argb: 'FFE599'},
																		bgColor : { argb: 'FFE599'}
