...
export default {
    ...
    components: {
        ...
        tabOrder: () => import("@/components/part/sw/10/SW10710_Order"),
        ...
        tabExport: () => import("@/components/part/sw/10/SW10710_ExportTemDataMax"),
        ...
        selectedTab(val) {
            ...
            //BEGIN SHINWOO VN========================================================================================================================
					...
					if(this.lstFactory=='DV')
					{
						...
						this.imp_template_file = 'report/sw/10/RPT_IMP_ORDER_DATAMAX_DV.xlsx';
						this.imp_store_prod = 'SW_IMP_SWSO710_DMX_ORDER_DV';
					} 
				...
				//BEGIN SHINWOO INDONEXIA
					if(this.lstFactory=='JV')
					{
						//alert(this.lstFactory);
						this.impEndCol = 125;
						this.imp_start_row=1;
						this.imp_template_file = 'report/sw/10/RPT_IMP_ORDER_DATAMAX_INDIA_INDO_JV.xlsx';
						this.imp_store_prod = 'SW_IMP_SWSO710_INDO_ORDER_JV';
					} 
					if(this.lstFactory=='KMK')
					{
						this.impEndCol = 55;
						this.imp_start_row=5;
						this.imp_template_file = 'report/sw/10/RPT_IMP_ORDER_DATAMAX_INDIA_INDO_KMK.xlsx';  
						this.imp_store_prod = 'SW_IMP_SWSO710_INDO_ORDER_KMK';
					}
					if(this.lstFactory=='JJ')
					{
						this.impEndCol = 124;
						this.imp_start_row=1;
						this.imp_template_file = 'report/sw/10/RPT_IMP_ORDER_DATAMAX_INDIA_INDO_JJ.xlsx';  
						this.imp_store_prod = 'SW_IMP_SWSO710_INDO_ORDER_JJ';
					}
					if(this.lstFactory=='RJ')
					{
						this.impEndCol = 98;
						this.imp_start_row=1;
						this.imp_template_file = 'report/sw/10/RPT_IMP_ORDER_DATAMAX_INDIA_INDO_RJ.xlsx';  
						this.imp_store_prod = 'SW_IMP_SWSO710_INDO_ORDER_RJ';
					}
					if(this.lstFactory=='NI')
					{
						this.impEndCol = 94;
						this.imp_start_row=1;
						this.imp_template_file = 'report/sw/10/RPT_IMP_ORDER_DATAMAX_INDIA_INDO_NIKOMAS.xlsx';  
						this.imp_store_prod = 'SW_IMP_SWSO710_INDO_ORDER_NI';
					}
					if(this.lstFactory=='IR')
					{
						this.impEndCol = 114;
						this.imp_start_row=1;
						this.imp_template_file = 'report/sw/10/RPT_IMP_ORDER_DATAMAX_INDIA_INDO_IR.xlsx';  
						this.imp_store_prod = 'SW_IMP_SWSO710_INDO_ORDER_IR';
					}
					if(this.lstFactory=='JX')
					{
						this.impEndCol = 81;
						this.imp_start_row=1;
						this.imp_template_file = 'report/sw/10/RPT_IMP_ORDER_DATAMAX_INDIA_INDO_JX.xlsx';  
						this.imp_store_prod = 'SW_IMP_SWSO710_INDO_ORDER_JX';
					}
					if(this.lstFactory=='SCI')
					{
						this.impEndCol = 59;
						this.imp_start_row=5;
						this.imp_template_file = 'report/sw/10/RPT_IMP_ORDER_DATAMAX_INDIA_INDO_SCI.xlsx';  
						this.imp_store_prod = 'SW_IMP_SWSO710_INDO_ORDER_SCI';
					}
					if(this.lstFactory=='SMJ')
					{
						this.impEndCol = 63;
						this.imp_start_row=1;
						this.imp_template_file = 'report/sw/10/RPT_IMP_ORDER_DATAMAX_INDIA_INDO_SMJ.xlsx';  
						this.imp_store_prod = 'SW_IMP_SWSO710_INDO_ORDER_SMJ';
					}
				//END SHINWOO INDONEXIA
            }
            /*if (val == "tabMCL") {//MCL
				this.tab_staus=2;
				//onChangeFactory();
			...
			if (val == "tabExport") {//Translate
				...
				//BEGIN SHINWOO VN========================================================================================================================
					if(this.lstFactory=='DV')
					{
						...
						this.impEndCol = 28;
						this.imp_start_row=5;
						this.imp_template_file = 'report/sw/10/RPT_IMP_ORDER_PRICE_DATAMAX_DV.xlsx';
						this.imp_store_prod = 'SW_UPD_SWSO710_DMX_ORDER_DV';
					} 
					if(this.lstFactory=='LW')
					{
						//alert(this.lstFactory);
				...
				//BEGIN SHINWOO INDONEXIA
					if(this.lstFactory=='JV')//NOT YET 31/05/2024
					{
						//alert(this.lstFactory+"-0-"+this.tab_staus);
						this.impEndCol = 7;
						this.imp_start_row=2;
						this.imp_template_file = 'report/sw/10/RPT_IMP_PRICE_DATAMAX_INDIA_INDO_JV.xlsx';
						this.imp_store_prod = 'SW_UPD_SWSO710_DMX_PRICE_INDO_JV';
					} 
					if(this.lstFactory=='NI')//NOT YET 31/05/2024
					{
						//alert(this.lstFactory+"-0-"+this.tab_staus);
						this.impEndCol = 15;
						this.imp_start_row=4;
						this.imp_template_file = 'report/sw/10/RPT_IMP_PRICE_DATAMAX_INDIA_INDO_NI.xlsx';
						this.imp_store_prod = 'SW_UPD_SWSO710_DMX_PRICE_INDO_NI';
					} 
					if(this.lstFactory=='IR')//NOT YET 31/05/2024
					{
						//alert(this.lstFactory+"-0-"+this.tab_staus);
						this.impEndCol = 39;
						this.imp_start_row=2;
						this.imp_template_file = 'report/sw/10/RPT_IMP_PRICE_DATAMAX_INDIA_INDO_IR.xlsx';
						this.imp_store_prod = 'SW_UPD_SWSO710_DMX_PRICE_INDO_IR';
					}
					if(this.lstFactory=='JX')//NOT YET 31/05/2024
					{
						//alert(this.lstFactory+"-0-"+this.tab_staus);
						this.impEndCol = 54;
						this.imp_start_row=2;
						this.imp_template_file = 'report/sw/10/RPT_IMP_PRICE_DATAMAX_INDIA_INDO_JX.xlsx';
						this.imp_store_prod = 'SW_UPD_SWSO710_DMX_PRICE_INDO_JX';
					}
					if(this.lstFactory=='SMJ')//NOT YET 31/05/2024
					{
						//alert(this.lstFactory+"-0-"+this.tab_staus);
						this.impEndCol = 41;
						this.imp_start_row=2;
						this.imp_template_file = 'report/sw/10/RPT_IMP_PRICE_DATAMAX_INDIA_INDO_SMJ.xlsx';
						this.imp_store_prod = 'SW_UPD_SWSO710_DMX_PRICE_INDO_SMJ';
					} 	
				//END SHINWOO INDONEXIA
            }
	...
	let report_main = "rpt_label_factory_datamax";
	let report = "rpt_dmx_factory_"+this.lstFactory+"_"+this.month.replace("-", "");
      try{
        this._ExcelSaveAs(await this.$axios.$get('/dso/makereport', {responseType: "blob", params: {
          ...
          excel: JSON.stringify([{
            insertRange: [{
              range: "A1:AJ1", proc: "SW_SEL_SWSO710_EXPORT_NOCACHE", params: [...p_param], dateColumns: [ "OGAC" ]//SW_SEL_SW10110_export_custom
            }],
            insertRows: [{
				startRow: 2, proc: "SW_SEL_SWSO710_EXPORT_NOCACHE", params: [...p_param], stringColumns: [ "SKU","CHN_NAME"], subStyle: { font : {   bold: true   } , fill: {
                                        type: 'pattern',
                                        pattern:'solid',
                                        fgColor : { argb: 'FFE599'},
                                        bgColor : { argb: 'FFE599'}
