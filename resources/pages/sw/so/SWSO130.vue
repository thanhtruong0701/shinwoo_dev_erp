...
export default {
    ...
    components: {
        ...
        tabAccount: () => import("@/components/part/sw/10/SW10130_Order"),
        tabCustomer: () => import("@/components/part/sw/10/SW10130_MCL"),
        tabBank: () => import("@/components/part/sw/10/SW10130_Translate"),
        tabPL: () => import("@/components/part/sw/10/SW10130_ExportTemParaguay"),
    ...
    watch: {
        selectedTab(val) {
            if (val == "tabAccount") {//ORDER
                    ...
                    //alert("company chang tab:"+this.selectedCompany);
					this.tab_staus=1;
					if(this.lstFactory=='VJ')
					{
						...
						this.imp_template_file = 'report/SW/10/RPT_IMP_ORDER_PARAGUAY_URAGUAY.xlsx';
						this.imp_store_prod = 'SW_IMP_SW10130_ORDER_VJ';
					} 
					if(this.lstFactory=='VW1' || this.lstFactory=='VW2')
					{
						...
						this.impEndCol = 9;
						this.imp_start_row=5;
						this.imp_template_file = 'report/SW/10/RPT_IMP_ORDER_PARAGUAY_URAGUAY_VW.xlsx';
						this.imp_store_prod = 'SW_IMP_SW10130_ORDER_VW';
					}
            ...
            if (val == "tabCustomer") {//MCL
				...
				this.impEndCol = 28;
				this.imp_start_row=2;
				this.imp_template_file = 'report/SW/10/RPT_IMP_MCL_PY_UY.xlsx';//PARAGUAY OR URAGUAY
				this.imp_store_prod = 'SW_IMP_SW10130_MCL_NOCACHE';
            }
    ...
    methods: {
		...
		//alert(this.lstFactory);
		//alert("change factory to cpy:"+this.selectedCompany);
        ...
        async save() {
            ...
            /*else if (this.selectedTab == "tabEmployee") {
                ...
                tab = 3;
				   ...
				   const dso = {
					type: "process",
					updpro: "SW_PRO_SW10130_DELETE_ORD_MCL",
