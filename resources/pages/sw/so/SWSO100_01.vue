...
export default {
    ...
    components: {
        ...
        tabAccount: () => import("@/components/part/sw/10/SW10100_01_Order"),
        tabCustomer: () => import("@/components/part/sw/10/SW10100_JAPAN_MCL"),
        tabBank: () => import("@/components/part/sw/10/SW10090_Translate"),
        tabPL: () => import("@/components/part/sw/10/SW10100_01_ExportTemJapan"),
        ...
        selectedTab(val) {
            ...
            if (val == "tabAccount") {//ORDER
					...
					if(this.lstFactory=='IWE')
					{
						...
						this.impValidValue ='JAPAN';
						this.impValidCol=17;
						this.imp_template_file = 'report/SW/10/RPT_IMP_ORDER_SWINDO_JP_IWE.xlsx';
						this.imp_store_prod = 'SW_IMP_SW10100_01_ORDER_IWE';
					} 
					if(this.lstFactory=='IWN')
					{
						...
						this.impValidValue ='JAPAN';
						this.impValidCol=17;
						this.imp_template_file = 'report/SW/10/RPT_IMP_ORDER_SWINDO_JP_IWN.xlsx';
						this.imp_store_prod = 'SW_IMP_SW10100_01_ORDER_IWN';
					}
					if(this.lstFactory=='IY')
					{
						//alert(this.lstFactory);
						this.impEndCol = 143;
						this.imp_start_row=1;
						this.impValidValue ='JP';
						this.impValidCol=24;
						this.imp_template_file = 'report/SW/10/RPT_IMP_ORDER_SWINDO_JP_IY.xlsx';
						this.imp_store_prod = 'SW_IMP_SW10100_01_ORDER_IY';
					}
					if(this.lstFactory=='IA')
					{
						//alert(this.lstFactory);
						this.impEndCol = 21;
						this.imp_start_row=18;
						this.imp_template_file = 'report/SW/10/RPT_IMP_ORDER_SWINDO_JP_IA.xlsx';
						this.imp_store_prod = 'SW_IMP_SW10100_01_ORDER_IA';
					}
					if(this.lstFactory=='IR')
					{
						//alert("0: "+this.lstFactory);
						this.impEndCol = 38;
						this.imp_start_row=6;
						this.imp_template_file = 'report/SW/10/RPT_IMP_ORDER_SWINDO_JP_IR.xlsx';
						this.imp_store_prod = 'SW_IMP_SW10100_01_ORDER_IR'; 
					}
					if(this.lstFactory=='JE')
					{
						...
						this.impEndCol = 152;
						this.imp_start_row=1;
						this.imp_template_file = 'report/SW/10/RPT_IMP_ORDER_SWINDO_JP_JE.xlsx';
						this.imp_store_prod = 'SW_IMP_SW10100_01_ORDER_JE'; 
					}
					if(this.lstFactory=='JJ')
					{
						//alert("0: "+this.lstFactory);
						this.impEndCol = 140;
						this.imp_start_row=8;
						this.impValidValue ='Japan';
						this.impValidCol=29;
						this.imp_template_file = 'report/SW/10/RPT_IMP_ORDER_SWINDO_JP_JJ.xlsx';
						this.imp_store_prod = 'SW_IMP_SW10100_01_ORDER_JJ'; 
					}
					if(this.lstFactory=='JX')
					{
						...
						this.imp_template_file = 'report/SW/10/RPT_IMP_ORDER_SWINDO_JP_JX.xlsx';
						this.imp_store_prod = 'SW_IMP_SW10100_01_ORDER_JX'; 
					}
					if(this.lstFactory=='PM')
					{
						...
						this.imp_template_file = 'report/SW/10/RPT_IMP_ORDER_SWINDO_JP_PM.xlsx';
						this.imp_store_prod = 'SW_IMP_SW10100_01_ORDER_PM'; 
					}
					if(this.lstFactory=='RJ')
					{
						...
						//this.impValidValue ='Japan';
						//this.impValidCol=28;
						this.imp_template_file = 'report/SW/10/RPT_IMP_ORDER_SWINDO_JP_RJ.xlsx';
						this.imp_store_prod = 'SW_IMP_SW10100_01_ORDER_RJ'; 
					}
					if(this.lstFactory=='SCI')
					{
						...
						//this.impValidValue ='Japan';
						//this.impValidCol=28;
						this.imp_template_file = 'report/SW/10/RPT_IMP_ORDER_SWINDO_JP_SCI.xlsx';
						this.imp_store_prod = 'SW_IMP_SW10100_01_ORDER_SCI'; 
					}
					if(this.lstFactory=='TT')
					{
						//alert("0: "+this.lstFactory);
						this.impEndCol = 116;
						this.imp_start_row=1;
						this.impValidValue ='Japan';
						this.impValidCol=9;
						this.imp_template_file = 'report/SW/10/RPT_IMP_ORDER_SWINDO_JP_TT.xlsx';
						this.imp_store_prod = 'SW_IMP_SW10100_01_ORDER_TT'; 
					}
					...
					if(this.lstFactory=='V3')
					{
						//alert(this.lstFactory);
						this.impEndCol = 11;
						this.imp_start_row=12;
						this.imp_template_file = 'report/SW/10/RPT_IMP_ORDER_TAIWAN_V3.xlsx';
						this.imp_store_prod = 'SW_IMP_SW10090_ORDER_V3';
					}
            }
            if (val == "tabCustomer") {//MCL
				...
				this.impValidValue ='JP';
				this.impValidCol=8;
                this.imp_template_file = 'report/SW/10/SW10100_JAPAN_MCL.xlsx';
                this.imp_store_prod = 'SW_IMP_SW10100_JAP_MCL_NOCACHE';
            }
    ...
    methods: {
		...
		//alert(this.lstFactory);
                ...
                if(this.tab_staus==1)
				{
					...
					if(this.lstFactory=='RJ') 
					{
						//alert("0: "+this.lstFactory); SW_IMP_SW10100_01_ORDER_RJ
						this.impEndCol = 139;
						this.imp_start_row=2;
						//this.impValidValue ='Japan';
						//this.impValidCol=28;
