        ...
        <v-row justify="center">
          <v-col cols="12">
            <v-card outlined tile>
              ...
              <v-row justify="end" class="mr-1">
                <v-col cols="6">
                  <GwImportExcelFile :label="$t('import_file')" :impTempFile="'resources/report/SW/Haein_Order_Template.xlsx'"
                    :impProc="'SW_IMP_HAEIN'" :impStartRow="1" :impEndCol="15"
                    :impValidValue="impValidValue" :impValidCol="impValidCol"
                    :impAddParam="[OrderDate]"
                    ></GwImportExcelFile>
                </v-col>                 
                <v-col cols="6">
                  <div class="d-flex justify-end">
        ...
        <v-row align="center" justify="space-between" no-gutters  class="pt-0">
            ...
            <v-col md="12" class="py-1">
              <DataGridView
                ...
                ref="dataGrid1"                   
                sel_procedure="SW_SEL_HAEIN_EXCEL"
