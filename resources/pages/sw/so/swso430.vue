              ...
              <v-row dense align="center" justify="space-between">
                ...
                <v-col cols="5">
				 <GwImportExcelFile 
                                ...
                                :impProc="'SW_PRO_SW10430_ORDER_NOCACHE'" 
                                :impStartRow="4" 
                                :impEndCol="8"
        ...
        <v-card>
          <v-row align="center" no-gutters>
            <BaseGridView
              ref="grdTags"
              :header="grdHeader"
              sel_procedure="SW_SEL_SWSO430_NOCACHE"
              :multiselect="true"
              :headertype="1"
...
export default {
  ...
  methods: {
	...
	onCellClickDataGrid1({BRANDGROUP, ORDERDATE, ORDERNO}) {
      ...
      this.report_name = BRANDGROUP + "_" + ORDERDATE + "_" + ORDERNO + "_imp_Y" + ".xlsx";
