  ...
  <v-container fluid class="px-0 pt-0" v-resize="onResize">
    <v-card class="pa-1 pt-0">
      <v-row align="center" justify="space-between" class="pt-2">
        ...
        <v-col md="2" class="pt-0">
          <BaseInput v-model="tab01.txtOrderNo" :label="$t('Order_No')"> </BaseInput>
        </v-col>
    ...
    <v-card class="pt-0">
      <v-row align="center" justify="space-between" class="pt-0">
        <v-col cols="12" class="pt-0">
          <BaseGridView ref="grdDetail11" column-resizing-mode="widget" :auto_load="false" select_mode="MultipleHideBox" :max_height="this.windowHeight * 0.75" sel_procedure="SW_SEL_SWSO01_NOCACHE" upd_procedure="SW_UPD_SWSO01_VINH" @onRowPrepared="onRowPreparedGrid11" :filter_paras="[tab01.lstCompany, tab01.dtOrderFrom, tab01.dtOrderTo, tab01.txtOrderNo]" :header="dataList.headerGrid11" :update_paras="['PK', 'ITEM_CODE', 'ITEM_NAME', 'ORDER_DATE', 'QTY', 'ITEM_TYPE', 'DESCRIPTION', 'FACTORY_CODE']" />
          <!-- <BaseGridView ref="grdDetail11" column-resizing-mode="widget" :auto_load="false" select_mode="MultipleHideBox" :max_height="this.windowHeight * 0.75" sel_procedure="SW_SEL_SWSO01_NOCACHE" upd_procedure="SW_UPD_SWSO01_VINH" @onRowPrepared="onRowPreparedGrid11" :filter_paras="[tab01.lstCompany, tab01.dtOrderFrom, tab01.dtOrderTo, tab01.txtOrderNo]" :header="dataList.headerGrid11" :update_paras="('ACTION', 'PK', 'ITEM_CODE', 'ITEM_NAME', 'ORDER_DATE', 'QTY', 'ITEM_TYPE', 'DESCRIPTION', 'FACTORY_CODE', 'LANGUAGE', 'CRT_BY')" /> -->
        </v-col>
      </v-row>
    </v-card>
  </v-container>
