...
<script>
  ...
  export default {
    ...
    data: () => ({
      ...
      dso : {
          type: 'grid',
          selpro: 'SW_SEL_SW10150_01',
          updpro: 'SW_UPD_SW10140',
          elname:[
            "_rowstatus", 'PK', 'PRODUCT_CODE', 'PRODUCT_NAME', 'item_type', 'LABEL_MCO', 'FACTORY_CODE', 'COMPANY_CODE','PO_NO','GAC_DATE', 'IMPORT_DATE','SIZE_NUM', 'ORDER_QTY', 'DELIVERY_QTY','DELIVERY_AMOUNT', 'COMMENTS'
          ],
          requirecol:[
    ...
    methods: {
        ...
        async createHeader(){
            ...
            this.header1 = [
                { title: ("ITEM_CODE"), field: "PRODUCT_CODE", editable: true, type: "", width: 100, fixed:true },
                { title: ("ITEM_NAME"), field: "PRODUCT_NAME", editable: true, type: "", width: 220, fixed:true },
                { title: ("ITEM_TYPE"), field: "ITEM_TYPE", editable: true, type: "", width: 80 },
                { title: ("LABEL_MCO"), field: "LABEL_MCO", editable: true, type: "", width: 90 },
                { title: ("FACTORY_CODE"), field: "FACTORY_CODE", editable: true, type: "", width: 60 },
                { title: ("COMPANY_CODE"), field: "COMPANY_CODE", editable: true, type: "", width: 70 },
				{ title: ("PO_NO"), field: "PO_NO", editable: true, type: "", width: 130 },
                { title: ("IMPORT_DATE"),  field: "IMPORT_DATE", editable: true, type: "", width: 100, cellclassname: this.changeBackground },
				{ title: ("SIZE_NUM"),     field: "SIZE_NUM", editable: true, type: "", width: 100 },
                { title: ("ORDER_QTY"),    field: "ORDER_QTY", editable: true, width: 100, type: "number" },
				{ title: ("DELIVERY_DATE"),  field: "GAC_DATE", editable: true, type: "", width: 100 },
                { title: ("DELIVERY_QTY"), field: "DELIVERY_QTY", editable: true, width: 120, type: "number" },
				{ title: ("DELIVERY_AMOUNT"), field: "DELIVERY_AMOUNT", editable: true, width: 120,type: "", format:"###,###,###.##", },
				{ title: ("COMMENTS"), field: "COMMENTS", editable: true, type: "", width: 100 },
