                    ...
                    <v-row   no-gutters> 
                         <v-col cols="3" class="pl-5 pt-3 pb-3">
						  <BaseSelect
							:label="$t('Customer')"
							v-model="sel_Company"
							:lstData="dataList.cbo_Company" 
							item-text="NAME"
							item-value="CODE"                   
                  />          
                            <!--BaseSelect outlined :label="$t('client')" v-model="sel_Company" :lstData="cbo_Company" :text_all="$t('select_all')" item-text="NAME" item-value="CODE"/-->
                        </v-col>
            ...
            <v-col cols="4" class="pt-2">
                <DataGridView
                    ...
                    :header="[ {  dataField: 'SEQ',       caption: this.$t('seq') , allowEditing: false  },
                               ...
                               {  dataField: 'CONFIRM_DT',   caption: this.$t('confirm_date') , allowEditing: false }, 
							   {  dataField: 'PK',   caption: this.$t('PK') , allowEditing: false },
                            ]" 
                    select_mode="Multiple"
                    :auto_load="true"
                    :max_height="this.windowHeight - 185"
                    sel_procedure="SZ_SEL_SW10070_2"
                    :filter_paras="[
                                    this.sel_Company, 
                                    this.txt_PO_NO,
                     ...
                     <v-row dense align="center" justify="space-between">
                        <DataGridView
                            ...
                            :header="[ {  dataField: 'SEQ',       caption: this.$t('seq') , allowEditing: true  },
                                    ...
                                    {  dataField: 'UPC_EAN_13_CODE',  caption: this.$t('upc_ean_13_code') , allowEditing: true,visible: false},
									...
									{  dataField: 'CURRENT_QTY',       caption: this.$t('current_qty') , allowEditing: false, summaryType:'sum' ,formatFloat:'0' ,visible:false},
									{  dataField: 'MAX_QTY',       caption: this.$t('max_qty') , allowEditing: false, summaryType:'sum' ,formatFloat:'0' ,visible:false},
                                    
                                ]" 
                            select_mode="Single"   
                            :auto_load="true"
                            :max_height="this.windowHeight/2-160"
                            sel_procedure="SZ_SEL_SW10020_1"
        ...
        /*############### created #######################*/
            ...
            {  
                //this.getCompanyList();
				 ...
				 //this.dataList.cbo_Company = await this._getCommonCode2(["SWWMT02_1"]);
				[this.dataList.cbo_Company] = await this._getCommonCode2(["SWWMT02"]);
				let reportjs = require("./js/SW10070.js");
				if (!!reportjs) {
        ...
        /*############### methods #######################*/
            ...
            {   
                    ...
                    { 
                        ...
                        if (result) 
                        {
                            this.dataList.cbo_Company = result;
                        } 
                        else 
                        {
                            this.dataList.cbo_Company = [];
                        }
                    },
					...
					async onPacking_list() {
						  ...
						  const report_path = "report/10/10/rpt_1010070_packing_list_walmart.xlsx"; // rpt_sw20030_packing_list
						  const report_name = "RPT_1010070_PACKING_LIST";
						 // alert("pkl");
						  this.print(this, report_path, report_name, this.TSZ_ORDER_PK);//resource\page\sw\10\js\print_walmart
						},
                    //-----------------------------------------------------------
