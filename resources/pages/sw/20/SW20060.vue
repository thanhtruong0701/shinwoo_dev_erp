    ...
    <GwGridLayout dense align="start" colsPerRow="1" containerHeight="auto" containerClass="py-0 px-1" @callBackHeight="parentHeight = $event">
      <GwGridLayout child dense flat colspan="4" align="start" colsPerRow="1" containerHeight="auto" containerClass="py-0 px-1" @callBackHeight="childrenHeight = $event">
        ...
        <DataGridView 
          ...
          ref="gridOrder" 
          :header="headersOrder" 
          sel_procedure="SW_SEL_SW20060_3_NOCACHE" 
      ...
      <GwGridLayout child dense flat colspan="8" align="start" colsPerRow="1" containerHeight="auto" containerClass="py-0 px-1" @callBackHeight="childrenHeight2 = $event">
        ...
        <GwGridLayout colspan="12" child dense flat align="start" colsPerRow="1" containerHeight="auto" containerClass="py-0 px-1">
          <BaseTabs @changed="tabChanged">
            <BaseTab :name="$t('color')" tabname="color" :eager="true">
              <DataGridView 
                ...
                ref="gridColor" 
                :header="headersColor" 
                sel_procedure="SW_SEL_SW20030_4_NOCACHE" 
          ...
          <GwFlexBox justify="space-between">
			...
			<v-spacer></v-spacer>
				<BaseButton :btn_text="$t('download_ALL_excel')" :disabled="isProcessing" :loading="isProcessing" @onclick="downloadExcel" />
			</GwFlexBox>
          ...
          <BaseGridView 
            ...
            ref="gridTID" 
            :header="headersTID" 
            sel_procedure="SW_SEL_SW20060_6_NOCACHE" 
  ...
  computed: {
    ...
    headersTID() {
      return [
        ...
        { dataField: "IF_SEQ", caption: this.$t("if_seq"), allowEditing: false , width: 80, fixed:true},
        { dataField: "SERIAL_CD", caption: this.$t("serial_cd"), allowEditing: false , width: 80, fixed:true},
        { dataField: "COLOR", caption: this.$t("color"), allowEditing: false , width: 80, fixed:true},
        { dataField: "SIZES", caption: this.$t("sizes"), allowEditing: false , width: 50, fixed:true},
    ...
    async downloadExcel() {
      try { 
        ...
        switch (this.selectedReportType) {
          case "1":
			reportPath = "report/sw/20/rpt_sw20060_order_detail.xlsx";
            proc = "SW_RPT_SW20060_6_NOCACHE";
