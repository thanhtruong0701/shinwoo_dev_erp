  ...
  <div>
    <GwGridLayout dense align="start" colsPerRow="1" containerHeight="auto" containerClass="py-0 px-1" @callBackHeight="parentHeight = $event">
      <GwGridLayout child dense flat colspan="4" align="start" colsPerRow="1" containerHeight="auto" containerClass="py-0 px-1" @callBackHeight="childrenHeight = $event">
		...
		<BaseSelect colspan="8" outlined :label="$t('Customer_Name')" item-text="NAME" item-value="CODE" :lstData="CustomerList" v-model="selectedCustomer" :text_all="$t('select_all')"/>
        <DataGridView 
          colspan="12" 
          column-resizing-mode="widget" 
          ref="gridOrder" 
          :header="headersOrder" 
          sel_procedure="SW_SEL_SW20130_3_NOCACHE" 
          :filter_paras="[fromDate, toDate,selectedCustomer]" 
          :filterRow="true" 
          select_mode="Single" 
          :auto_load="false" 
      ...
      <GwGridLayout child dense flat colspan="8" align="start" colsPerRow="1" containerHeight="auto" containerClass="py-0 px-1" @callBackHeight="childrenHeight2 = $event">
         <GwFlexBox colspan="4" align-self="center" justify="end">
          <!--BaseButton :btn_text="$t('interface_to_fnf_by_barcode')" :disabled="isProcessing" :loading="isProcessing" @onclick="setPrinter" /-->
        </GwFlexBox>
        ...
        <GwGridLayout colspan="12" child dense flat align="start" colsPerRow="1" containerHeight="auto" containerClass="py-0 px-1">
          <BaseTabs @changed="tabChanged">
            <BaseTab :name="$t('color')" tabname="color" :eager="true">
              <DataGridView 
                ...
                ref="gridColor" 
                :header="headersColor" 
                sel_procedure="SW_SEL_SW20130_4_NOCACHE" 
                :filter_paras="[P_BRANDGROUP, P_ORDERDATE, P_ORDERNO]" 
                :filterRow="true" 
                select_mode="Multiple" 
                :auto_load="false" 
                :max_height="gridHeight2 - 35 - 20" 
            ...
            <BaseTab :name="$t('material')" tabname="material" :eager="true">
              <DataGridView 
                ...
                sel_procedure="SW_SEL_SW20030_5_NOCACHE" 
                :filter_paras="[P_BRANDGROUP, P_ORDERDATE, P_ORDERNO]" 
                :filterRow="true" 
                select_mode="Single" 
                :auto_load="false" 
          ...
          <GwFlexBox justify="space-between">
            ...
            <v-spacer></v-spacer>
          <!--BaseButton :btn_text="$t('interface_to_fnf_by_rfcd')" :disabled="isProcessing" :loading="isProcessing" @onclick="Interface_Detail" /-->
          ...
          <BaseGridView 
            ...
            ref="gridTID" 
            :header="headersTID" 
            sel_procedure="SW_SEL_SW20130_6_NOCACHE" 
            :filter_paras="[P_BRANDGROUP, P_ORDERDATE, P_ORDERNO, P_COLOR, P_SIZES]" 
            :filterRow="true" 
            select_mode="Multiple" 
            :auto_load="false" 
            :max_height="gridHeight2 - 36 - 35 - 20"
            @rowCount="gridTIDTotalRow = $event"
			@cellClickData="onCellClickDataGrid3"
          />
		  ...
		  <BaseGridView 
            ...
            column-resizing-mode="widget" 
            ref="gridTID_HIS" 
            :header="headersTID_HIS" 
            sel_procedure="SW_SEL_SW20130_7_NOCACHE" 
            :filter_paras="[P_TID_PK]" 
            :filterRow="true" 
            select_mode="Multiple" 
            :auto_load="false" 
            :max_height="gridHeight2 - 36 - 35 - 20"
...
export default {
  ...
  async created() {
    [this.printerList, this.printerStatusList, this.CustomerList] = await this._getCommonCode2(["SZ001", "SZ006", "SZ008"]);
  },
  ...
  computed: {
    ...
    headersColor() {
      return [
        ...
        { dataField: "IF_FLAG", caption: this.$t("interface_yn"), allowEditing: false },
        { dataField: "IF_DATE", caption: this.$t("interface_date"), allowEditing: false },
    ...
    headersTID() {
      return [
        {dataField: 'CHK',caption: this.$t('CHK'), allowEditing: true,dataType:'checkbox' , width: 50},
        { dataField: "IF_SEQ", caption: this.$t("if_seq"), allowEditing: false , width: 80, fixed:true, cellClassName : this.cellClassName},
        { dataField: "SERIAL_CD", caption: this.$t("serial_cd"), allowEditing: false , width: 80, fixed:true , cellClassName : this.cellClassName},
        { dataField: "COLOR", caption: this.$t("color"), allowEditing: false , width: 80, fixed:true, cellClassName : this.cellClassName},
        { dataField: "SIZES", caption: this.$t("sizes"), allowEditing: false , width: 50, fixed:true, cellClassName : this.cellClassName},
        { dataField: "RFID_CD", caption: this.$t("rfid_cd"), allowEditing: false , width: 250, fixed:true},
        { dataField: "CD_RFIDTID", caption: this.$t("tid"), allowEditing: false , width: 250, fixed:true},      
        { dataField: "IF_FLAG", caption: this.$t("interface"), allowEditing: false , width: 100, },
        { dataField: "IF_DATE", caption: this.$t("interface_date"), allowEditing: false , width: 100, },

        { dataField: "FNF_PROCESS", caption: this.$t("fnf_process"), allowEditing: false , width: 100, },
        { dataField: "FNF_PROCESS_DATE", caption: this.$t("fnf_process_date"), allowEditing: false , width: 100, },

        { dataField: "RFID_BRAND", caption: this.$t("rfid_brand"), allowEditing: false , width: 100, },
        { dataField: "ORDERCOMPANY", caption: this.$t("ordercompany"), allowEditing: false, width: 100,  },
        { dataField: "IF_NO", caption: this.$t("if_no"), allowEditing: false, bgColor: this.bgColor1, width: 100,},
        { dataField: "IF_GUBUN", caption: this.$t("if_gubun"), allowEditing: false, width: 100,  },       
        { dataField: "BRANDGROUP", caption: this.$t("brandgroup"), allowEditing: false , width: 100, },
        { dataField: "ORDERDATE", caption: this.$t("orderdate"), dataType: "date", allowEditing: false , width: 100, },
        { dataField: "ORDERNO", caption: this.$t("orderno"), allowEditing: false , width: 100, },
        { dataField: "CREATE_DATE", caption: this.$t("create_date"), allowEditing: false , width: 100}, 
		{ dataField: "PK", caption: this.$t("PK"), allowEditing: false , width: 100,visible: false}, 
		{ dataField: "ISTOTAL", caption: this.$t("istotal"), allowEditing: false , width: 100, cellClassName : this.cellClassName,visible: false},	
      ];
    },
	headersTID_HIS() {
      return [
        ...
        { dataField: "ORDERNO", caption: this.$t("orderno"), allowEditing: false , width: 100, },
        { dataField: "CREATE_DATE", caption: this.$t("create_date"), allowEditing: false , width: 100}, 
		{ dataField: "ISTOTAL", caption: this.$t("istotal"), allowEditing: false , width: 100, cellClassName : this.cellClassName,visible: true},	
      ];
    },
  },
  ...
  methods: {
	...
	//---------------------SETCOLOR-----------HAS--HISTORY---TID---for-------Datagidview--------
	...
	//------------------setcolor--------his------with--basegridview--------------
	cellClassName  (row, columnfield, value,rowdata) {
            if(rowdata.ISTOTAL === 1) {
                return "cellChangedSW20130";
            }
            
            /*if(columnfield == "NEW_THR_WG_PK" && rowdata.NEW_THR_WG_PK != rowdata.OLD_THR_WG_PK) {
                return "cellChangedSW20130";
            }*/
    ...
    async setPrinter() {
      try {
        ...
        const dso = { 
          type: "process", 
          updpro: "SW_PRO_SW20060_INTERFAE_M", 
	...
	onCellClickDataGrid3({PK}) {
      this.P_TID_PK = PK;
      this.$refs.gridTID_HIS.loadData();
    },
