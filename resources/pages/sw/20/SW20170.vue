<template>
  <GwGridLayout dense align="start" colsPerRow="1" containerHeight="auto" @callBackHeight="parentHeight = $event">
	...
	<BaseInput colspan="2" outlined :label="$t('order_no')" v-model="inputBrand" />
    ...
    <DataGridView colspan="12" column-resizing-mode="widget" 
      ref="dataGrid" 
      :header="headers" 
      sel_procedure="SW_SEL_SW20170_1_NOCACHE"
...
export default {
  ...
  computed: {
    ...
    headers() {
      ...
      return [
		{ dataField: "ORDERDATE", caption: this.$t("ORDERDATE"),  allowEditing: true },	   
        { dataField: "FACTORY", caption: this.$t("FACTORY"), allowEditing: false },
		...
		{ dataField: "QTY", caption: this.$t("QTY"), allowEditing: false ,formatFloat: '0'},
		{ dataField: "LOSS", caption: this.$t("LOSS"), allowEditing: false ,formatFloat: '0'},
		{ dataField: "TOTAL_PRINT", caption: this.$t("TOTAL_PRINT"), allowEditing: false ,formatFloat: '0'},
		{ dataField: "PRINTTING_DATE", caption: this.$t("PRINTTING_DATE"), allowEditing: false },
		{ dataField: "INTERFACE_DATE", caption: this.$t("INTERFACE_DATE"), allowEditing: false },
		{ dataField: "DELIVERY_DATE", caption: this.$t("DELIVERY_DATE"), allowEditing: false },
		{ dataField: "CONFIRM", caption: this.$t("CONFIRM"), allowEditing: false },
		{ dataField: "REMARK", caption: this.$t("REMARK"), allowEditing: false },
      ];
    },
    gridHeight() {
  ...
  methods: {
	...
	let report = "rpt_sw20170_sale_order_inquiry";
	  ...
	  //alert(p_param);
        this._ExcelSaveAs(await this.$axios.$get('/dso/makereport', {responseType: "blob", params: {
          ...
          excel: JSON.stringify([{
            insertRange: [{
              range: "A1:AJ1", proc: "SW_SEL_SW20170_1_NOCACHE", params: [...p_param]//SW_SEL_SW10110_export_custom
            }],
            insertRows: [{
				startRow: 3, proc: "SW_SEL_SW20170_1_NOCACHE", params: [...p_param], stringColumns: [ "STYLE_NO","ORDERNO"], subStyle: { font : {   bold: true   } , fill: {
                                        type: 'pattern',
                                        pattern:'solid',
                                        fgColor : { argb: 'FFE599'},
                                        bgColor : { argb: 'FFE599'}
