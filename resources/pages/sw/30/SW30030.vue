    ...
    <GwGridLayout dense align="start" colsPerRow="1" containerHeight="auto" containerClass="py-0 px-1" @callBackHeight="parentHeight = $event">
      <GwGridLayout child dense flat colspan="4" align="start" colsPerRow="1" containerHeight="auto" containerClass="py-0 px-1" @callBackHeight="childrenHeight = $event">
       <BaseDatePicker colspan="3" outlined default :clearable="false" :label="$t('from_date')" v-model="fromDate" />
        ...
        <BaseSelect colspan="3" outlined :label="$t('uv')" item-value="value" item-text="text" :lstData="uvList" v-model="selecteduv" :text_all="$t('select_all')" />
        ...
        <BaseSelect colspan="4" outlined :label="$t('handle_with_care')" item-value="value" item-text="text" :lstData="HandleList" v-model="selectedhandle_with_care" :text_all="$t('select_all')" />
        ...
        <DataGridView 
          ...
          ref="gridOrder" 
          :header="headersOrder" 
          sel_procedure="SW_SEL_SW30030_3_TEST" 
          :filter_paras="[fromDate, toDate,selecteduv,selectedlabel_type,selectedrfid_yn,selectedhandle_with_care]" 
          :filterRow="true" 
          select_mode="Single" 
          :auto_load="false" 
      ...
      <GwGridLayout child dense flat colspan="8" align="start" colsPerRow="1" containerHeight="auto" containerClass="py-0 px-1" @callBackHeight="childrenHeight2 = $event">
        ...
        <GwGridLayout colspan="12" child dense flat align="start" colsPerRow="1" containerHeight="auto" containerClass="py-0 px-1">
          ...
          <DataGridView 
            ...
            ref="gridTID" 
            :header="headersTID" 
            sel_procedure="SW_SEL_SW30030_6_TEST" 
...
export default {
  ...
  async created() {
    [this.printerList, this.printerStatusList,this.LabelList] = await this._getCommonCode2(["SZ001", "SZ006","SZ007"]);
  },
  ...
  computed: {
    ...
    labeltypeList() {
      return [
               { value: "KCARE", text: this.$t("Korean Carelabel") }, 
               { value: "ECCARE", text: this.$t("EC Carelabel") }, 
               { value: "PTG", text: this.$t("Price Tag - Global") }, 
               { value: "PTC", text: this.$t("Price Tag - China") }, 
  ...
  methods: {
    ...
    async setPrinter() {
      try {
        ...
        const dso = { 
          type: "process", 
          updpro: "SW_PRO_SW20030_SET_PRINT_TEST", 
      ...
      try { 
        ...
        switch (this.selectedReportType) {
          case "1":
            ...
            break;
          case "1.1":
            reportPath = "report/SW/30/RPT_SW30030_RFID_Y_TEST.xlsx";
            proc = "SW_RPT_SW30030_RFID_Y_TEST";
            //reportName = "RPT_SW20030_RFID_Y_1.xlsx";
            params = this.reportParams;
            break;
          case "1.2":
            reportPath = "report/SW/30/RPT_SW30030_RFID_N_TEST.xlsx";
            proc = "SW_RPT_SW30030_RFID_N_TEST";
          ...
          case "2.2":
            ...
            break;
          case "2.3":
            reportPath = "report/SW/30/RPT_SW30030_CARELABEL_TEST.xlsx"; // this.reportType.template;
    ...
    async excelDownloadByBarcode() {
      try {
        ...
        let excel = [];
        const headerRows = ["Goods", "Barcode", "QR Code", "Sizes", "Color", "Gubun", "Material", "Mixrate", "Country", "Order name", "Product YM", "Degree", "Serial Number", "Quantity Color","STYLE_DEGREE_COLOR_SIZE","BARCODE2"];
        excel = [
          {
            sheet: 1,
            insertHeader: [
