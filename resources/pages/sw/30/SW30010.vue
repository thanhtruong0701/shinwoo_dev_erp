	...
	<div>
		<GwGridLayout dense align="start" colsPerRow="1" containerHeight="auto" @callBackHeight="parentHeight = $event">
			...
			<DataGridView
				...
				sel_procedure="SW_SEL_SW30010_1_TEST"
				:filter_paras="[this.txtFrm_dt, this.txtTo_dt,this.selectedStatus]"
				:filterRow="true"
			...
			<BaseTabs colspan="12" @tabchanged="onClickButton">
				<BaseTab :name="$t('color')">
					<DataGridView
						...
						ref="grd_Color"
						:header="headersColor"
						sel_procedure="SW_SEL_SW30010_2_TEST"
				...
				<BaseTab :name="$t('material')">
					<DataGridView
						...
						sel_procedure="SW_SEL_SW30010_3_TEST"
						:filter_paras="[this.p_BRANDGROUP,this.p_ORDERDATE,this.p_ORDERNO]"
						upd_procedure=""
						select_mode="MultipleHideBox"
						:auto_load="false"
				...
				<BaseTab :name="$t('RFID')">
					<DataGridView
						...
						ref="grd_RFID"
						:header="headersRFID"
						sel_procedure="SW_SEL_SW30010_4_TEST"
						:filter_paras="[this.p_BRANDGROUP,this.p_ORDERDATE,this.p_ORDERNO]"
						:filterRow="true"
						select_mode="MultipleHideBox"
						:auto_load="false"
