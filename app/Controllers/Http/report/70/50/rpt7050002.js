...
class rpt7050002 {
    async rpt7050002_01({ request, response, auth }) {
        try {
            /****************************** Get Param *********************************/
            ...
            /****************************** Begin call store and write excell *********/
                ...
                for (var i = 0; i < dt_m.length; i++) {
                    ...
                    row.getCell(1).value = dt_m[i].MONTH_;
                    row.getCell(2).value = dt_m[i].AP_TRAMT_10;
                    row.getCell(3).value = dt_m[i].AP_TRAMT_20;
                    row.getCell(4).value = dt_m[i].AP_TRAMT_30;
                    row.getCell(5).value = dt_m[i].AP_TRAMT_40;
                    row.getCell(6).value = dt_m[i].AP_TRAMT_TTL;
                ...
                for (var i = 0; i < dt_m3.length; i++) {
                    ...
                    row.getCell(4).value = dt_m3[i].AP_TRAMT_10;
                    row.getCell(5).value = dt_m3[i].AP_TRAMT_20;
                    row.getCell(6).value = dt_m3[i].AP_TRAMT_30;
                    row.getCell(7).value = dt_m3[i].AP_TRAMT_40;
                    row.getCell(10).value = dt_m3[i].AP_TRAMT_TTL;
