...
class rpt6015016 {
/*########################################################## Report JH ##################################################################################*/ 
    async rpt_6015016({ request, response, auth }) {
        try 
        { 
          /*P_RPT_ID: report_info.VAL1, P_RPT_FILE: report_info.VAL2,
            ...
            var _store          = "AC_RPT_6015016_ACC_INQUIRY";
        ...
        {
            Utils.Logger({ LVL: "error", MODULE: "Report", FUNC: "rpt_6015016", CONTENT: e.message })
