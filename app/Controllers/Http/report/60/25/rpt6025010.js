...
class rpt6025010 {
/*########################################################## Report JH ##################################################################################*/ 
    async rpt_6025010_R({ request, response, auth }) {
        try 
        { 
          /*P_RPT_ID: report_info.VAL1, P_RPT_FILE: report_info.VAL2,
            ...
            var _store          = "AC_RPT_6025010_R";
            var _param          = [ item.P_COMPANY, item.P_SEQ, item.P_CIRCULARS, item.P_BOOK_CCY];
            var ESJS0010_ESIGN_TYPE      = item.ESIGN_TYPE;
            var chkEsign        = (ESJS0010_ESIGN_TYPE != "" && ESJS0010_ESIGN_TYPE != "null" && ESJS0010_ESIGN_TYPE != null)?'Y':'N';
             /***************************** Return failded ****************************/
            if (!user) 
            { 
