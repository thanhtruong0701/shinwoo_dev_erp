    ...
    async rpt_CS50040_Billing_2({ request, response, auth }) {
        try {
            ...
            /****************************** Begin call store and write excell *********/
                ...
                var dt_m = await DBService.callProcCursor("CW_RPT_CS50040_1_1_NOCACHE", _param, p_language, p_crt_by, item.SECOND_DB_YN);
                var dt_stock = await DBService.callProcCursor("CW_RPT_CS50040_20_NOCACHE", _param, p_language, p_crt_by, item.SECOND_DB_YN);
                var dt_service = await DBService.callProcCursor("CW_RPT_CS50040_1_3_NOCACHE", _param, p_language, p_crt_by, item.SECOND_DB_YN);
