...
class rptCS50010_1 {
    async rpt_CS50010_Billing_1({ request, response, auth }) {
        try {
                /****************************** Get Param *********************************/
            ...
            { 
                    ...
                    var dt_m   = await DBService.callProcCursor("CW_RPT_CS50030_M_NOCACHE", _param , p_language , p_crt_by,item.SECOND_DB_YN); 
                    var dt_stock   = await DBService.callProcCursor("CW_RPT_CS50030_STOCK_NOCACHE", _param , p_language , p_crt_by,item.SECOND_DB_YN);
                    var dt_service   = await DBService.callProcCursor("CW_RPT_CS50030_SER_NOCACHE", _param , p_language , p_crt_by,item.SECOND_DB_YN);
