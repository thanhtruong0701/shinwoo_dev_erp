    ...
    async rpt_CS50040_Billing_6({ request, response, auth }) {
        try {
            ...
            /****************************** Begin call store and write excell *********/
                ...
                var dt_m = await DBService.callProcCursor("CW_RPT_CS50040_61_NOCACHE", _param, p_language, p_crt_by, item.SECOND_DB_YN);
                var dt_stock = await DBService.callProcCursor("CW_RPT_CS50040_63_NOCACHE", _param, p_language, p_crt_by, item.SECOND_DB_YN);
                var dt_service = await DBService.callProcCursor("CW_RPT_CS50040_62_NOCACHE", _param, p_language, p_crt_by, item.SECOND_DB_YN);
                ...
                var pos_sum1 = 0;
                console.log('stock_merge' + stock_merge);
