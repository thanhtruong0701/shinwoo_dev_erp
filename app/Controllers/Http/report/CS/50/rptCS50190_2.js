...
class rptCS50190_2 {
    async rpt_CS50190_Group({ request, response, auth }) {
        try {
            /****************************** Get Param *********************************/
            ...
            /****************************** Begin call store and write excell *********/
                ...
                var dt_stock = await DBService.callProcCursor("CW_CS50190_G_STOCK_NOCACHE", _param, p_language, p_crt_by, item.SECOND_DB_YN);
                var dt_service = await DBService.callProcCursor("CW_RPT_CS50190_G_SERV_NOCACHE", _param, p_language, p_crt_by, item.SECOND_DB_YN);
