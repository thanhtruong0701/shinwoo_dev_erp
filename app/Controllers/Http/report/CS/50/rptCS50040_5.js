    ...
    async rpt_CS50040_Billing_5({ request, response, auth }) {
        try {
            ...
            /****************************** Begin call store and write excell *********/
                ...
                var dt_m = await DBService.callProcCursor("CW_RPT_CS50040_SUM_NOCACHE", _param, p_language, p_crt_by, item.SECOND_DB_YN);
                var dt_stock = await DBService.callProcCursor("CW_RPT_CS50040_53_NOCACHE", _param, p_language, p_crt_by, item.SECOND_DB_YN);
                var dt_service = await DBService.callProcCursor("CW_RPT_CS50040_52_NOCACHE", _param, p_language, p_crt_by, item.SECOND_DB_YN);
