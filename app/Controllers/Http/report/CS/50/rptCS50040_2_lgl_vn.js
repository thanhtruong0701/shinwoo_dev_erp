...
class rptCS50040_2_lgl_vn {
    async rpt_cs50040_billing_2_lgl_vn({ request, response, auth }) {
        try {
            /****************************** Get Param *********************************/
           ...
           // var _store = "CW_RPT_CS50040_1_1_NOCACHE";
            ...
            /****************************** Begin call store and write excell *********/
                ...
                var dt_m = await DBService.callProcCursor("CW_RPT_CS50040_1_1_NOCACHE", _param, p_language, p_crt_by, item.P_SECOND_DB_YN);
                var dt_stock = await DBService.callProcCursor("CW_RPT_CS50040_20_NOCACHE", _param, p_language, p_crt_by, item.P_SECOND_DB_YN);
                var dt_service = await DBService.callProcCursor("CW_RPT_CS50041_1_3_NOCACHE", _param, p_language, p_crt_by, item.P_SECOND_DB_YN);
                ...
                worksheet.getCell("AB7").value = dt_m[0].CCY;
                ...
                for (var j = 0; j < dt_service.length; j++) {
                    ...
                    row_s.getCell(2).value = dt_service[j].SEVICE_NAME_INVOICE;
...
module.exports = rptCS50040_2_lgl_vn;