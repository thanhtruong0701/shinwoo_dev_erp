...
class rptCS50040_5_lgl {
    async rpt_cs50040_billing_5_lgl({ request, response, auth }) {
        try {
            /****************************** Get Param *********************************/
            ...
            /****************************** Begin call store and write excell *********/
                ...
                var dt_m = await DBService.callProcCursor("CW_RPT_CS50040_SUM_NOCACHE", _param, p_language, p_crt_by, item.P_SECOND_DB_YN);
                var dt_stock = await DBService.callProcCursor("CW_RPT_CS50040_53_NOCACHE", _param, p_language, p_crt_by, item.P_SECOND_DB_YN);
                var dt_service = await DBService.callProcCursor("CW_RPT_CS50040_52_NOCACHE", _param, p_language, p_crt_by, item.P_SECOND_DB_YN);
                ...
                worksheet.getCell("M5").value = dt_m[0].GRP_NM; 
...
module.exports = rptCS50040_5_lgl;