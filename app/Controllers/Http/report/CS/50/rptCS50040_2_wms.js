...
class rptCS50040_2_wms {
    async rpt_CS50040_Billing_2({ request, response, auth }) {
        try {
            /****************************** Get Param *********************************/
            ...
            /****************************** Begin call store and write excell *********/
                ...
                var dt_service = await DBService.callProcCursor("CW_RPT_CS50040_1_3_NOCACHE", _param, p_language, p_crt_by, item.P_SECOND_DB_YN);
...
module.exports = rptCS50040_2_wms;