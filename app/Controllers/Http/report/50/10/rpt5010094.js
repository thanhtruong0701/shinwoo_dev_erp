...
class rpt5010094 {
    async rpt5010094_01({ request, response, auth }) {
        try {
            /****************************** Get Param *********************************/
            ...
            /****************************** Begin call store and write excell *********/
                ...
                const month1 = item.P_MONTH_D;

                let month2 = "";
                if(month1 && month1.trim() != "") {
                    month2 = month1.substr(0, 4) + "/" + month1.substr(5, 2);
                }
                row.getCell(3).value = month2;
